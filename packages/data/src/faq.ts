...
export const faqItems: FaqItem[] = [
  ...
  // ============================================================
  {
    ...
    answer: {
      ...
      de: "Die FIFA WM 2026 beginnt am 11. Juni 2026 mit dem Eröffnungsspiel im Estadio Azteca in Mexiko-Stadt zwischen Mexiko und Südafrika. Das Turnier erstreckt sich über 39 Tage und endet mit dem Finale am 19. Juli 2026 im MetLife Stadium in New York/New Jersey. Es ist die erste Weltmeisterschaft, die gemeinsam von drei Ländern ausgerichtet wird: den USA, Mexiko und Kanada.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Wie viele Mannschaften nehmen an der WM 2026 teil?",
    },
    answer: {
      ...
      de: "Die WM 2026 umfasst 48 Mannschaften, ein historisches Novum im Wettbewerb. Zuvor war das Format seit 1998 auf 32 Teams beschränkt. Die Erweiterung ermöglicht es mehr Nationen, insbesondere aus Afrika, Asien und der CONCACAF-Region, am größten Fußballturnier der Welt teilzunehmen. Die 48 Teams werden in 12 Gruppen zu je 4 Mannschaften aufgeteilt.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Wie ist das Format der WM 2026 (48 Teams, 12 Gruppen)?",
    },
    answer: {
      fr: "Le nouveau format comprend une phase de groupes avec 12 groupes de 4 équipes. Les deux premiers de chaque groupe et les 8 meilleurs troisièmes se qualifient pour les 16es de finale, soit 32 équipes en phase a élimination directe. La competition comporte ensuite des 16es de finale, des huitièmes de finale, des quarts de finale, des demi-finales, un match pour la troisième place et la finale. Au total, 104 matchs seront joues contre 64 dans le format précédent.",
      ...
      de: "Das neue Format umfasst eine Gruppenphase mit 12 Gruppen zu je 4 Teams. Die beiden Gruppenersten sowie die 8 besten Gruppendritten qualifizieren sich für das Achtelfinale, sodass 32 Mannschaften in die K.o.-Runde einziehen. Anschließend folgen Achtelfinale, Viertelfinale, Halbfinale, das Spiel um Platz 3 und das Finale. Insgesamt werden 104 Spiele ausgetragen, gegenüber 64 im bisherigen Format.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Wo findet die WM 2026 statt?",
    },
    answer: {
      ...
      de: "Die WM 2026 wird gemeinsam von den USA, Kanada und Mexiko ausgerichtet. Der Großteil der Spiele (60) findet in den USA in 11 verschiedenen Städten statt. Kanada empfängt Spiele in Toronto und Vancouver, Mexiko in Mexiko-Stadt, Guadalajara und Monterrey. Das Finale wird im MetLife Stadium in New York/New Jersey ausgetragen, das mehr als 82.000 Zuschauer fasst.",
    },
    category: "tournament",
  },
  {
    ...
    answer: {
      ...
      de: "Die WM 2026 umfasst rekordverdächtige 104 Spiele insgesamt. Die Gruppenphase beinhaltet 72 Partien (12 Gruppen x 6 Spiele), gefolgt von 16 Achtelfinal-Spielen, 8 Viertelfinalspielen, 4 Halbfinalspielen, dem Spiel um Platz 3 und dem Finale. Das Turnier läuft vom 11. Juni bis zum 19. Juli 2026, also knapp 6 Wochen.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Welche Städte sind Austragungsorte der WM 2026?",
    },
    answer: {
      ...
      de: "Die WM 2026 wird in 16 Stadien in 16 Austragungsstädten gespielt. In den USA: New York/New Jersey (MetLife Stadium), Los Angeles (SoFi Stadium), Dallas (AT&T Stadium), Houston (NRG Stadium), Atlanta (Mercedes-Benz Stadium), Philadelphia (Lincoln Financial Field), Miami (Hard Rock Stadium), Seattle (Lumen Field), San Francisco (Levi's Stadium), Kansas City (Arrowhead Stadium) und Boston (Gillette Stadium). In Kanada: Toronto (BMO Field) und Vancouver (BC Place). In Mexiko: Mexiko-Stadt (Estadio Azteca), Guadalajara (Estadio Akron) und Monterrey (Estadio BBVA).",
    },
    category: "tournament",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Sind Sportwetten auf die WM legal?",
    },
    answer: {
      ...
      de: "In Deutschland sind Sportwetten seit dem Glücksspielstaatsvertrag 2021 (GlüStV 2021) bundesweit reguliert. Die Gemeinsame Glücksspielbehörde der Länder (GGL) vergibt Lizenzen an geprüfte Anbieter wie Betano, Tipico oder bet365. Wetten bei einem GGL-lizenzierten Anbieter sind legal und sicher. Prüfen Sie vor der Anmeldung stets, ob der Anbieter über eine gültige deutsche Lizenz verfügt. Wir empfehlen verantwortungsvollen Umgang mit Glücksspielen und raten, nur Beträge zu setzen, deren Verlust Sie sich leisten können.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Wie kann man auf die WM 2026 wetten?",
    },
    answer: {
      ...
      de: "Um auf die WM 2026 zu wetten, wählen Sie zunächst einen seriösen, GGL-lizenzierten Wettanbieter. Erstellen Sie ein Konto, verifizieren Sie Ihre Identität und leisten Sie eine Einzahlung. Anschließend können Sie auf verschiedene Märkte wetten: Turniersieger, Spielergebnisse (1X2), Torzahl, Torschützen und viele weitere Optionen. Vergleichen Sie die Quoten mehrerer Anbieter, um die besten Werte zu finden. Legen Sie ein festes Budget fest und halten Sie sich daran. Unsere Prognoseleitfäden helfen Ihnen dabei, Ihre Auswahl zu verfeinern.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Was ist eine Value Bet (Wette mit Wert)?",
    },
    answer: {
      ...
      de: "Eine Value Bet ist eine Wette, bei der die tatsächliche Wahrscheinlichkeit eines Ergebnisses höher ist als die vom Wettanbieter angebotene Quote impliziert. Wenn Sie beispielsweise glauben, dass eine Mannschaft 50 % Siegchance hat, der Anbieter aber nur 40 % einpreist, handelt es sich um eine Value Bet. Konsequent Value Bets zu identifizieren ist der Schlüssel zu einer langfristig profitablen Wettstrategie. Unsere ELO-basierten Prognosemodelle helfen Ihnen, solche Chancen zu erkennen.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Welche Quotenformate werden bei Sportwetten verwendet?",
    },
    answer: {
      ...
      de: "Es gibt drei gängige Quotenformate bei Sportwetten. Dezimalquoten (2,50) sind in Deutschland und ganz Europa am verbreitetsten: Ihr Gesamtgewinn = Einsatz x Quote. Bruchquoten (3/2) sind im Vereinigten Königreich populär: der Zähler zeigt den Gewinn im Verhältnis zum Einsatz. Amerikanische Quoten (+150 oder -200) sind in den USA Standard: ein Plus-Zeichen gibt den Gewinn auf 100 $ an, ein Minus-Zeichen den Einsatz, um 100 $ zu gewinnen. Die meisten Wettanbieter ermöglichen das Umschalten zwischen diesen Formaten in den Kontoeinstellungen.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Was ist ein Willkommensbonus bei einem Wettanbieter?",
    },
    answer: {
      ...
      de: "Ein Willkommensbonus ist ein Werbeangebot, das Wettanbieter neuen Kunden beim Registrieren unterbreiten. Er kann verschiedene Formen annehmen: Gratiswetten (Freebets), Einzahlungsbonusse (z. B. 100 % bis zu 100 EUR) oder Rückerstattung der ersten verlorenen Wette. Diese Angebote unterliegen Umsatzbedingungen (Rollover), die erfüllt sein müssen, bevor Gewinne ausgezahlt werden können. Lesen Sie stets die Allgemeinen Geschäftsbedingungen sorgfältig durch und vergleichen Sie die Angebote verschiedener Anbieter vor der Anmeldung.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Was bedeutet 1X2 bei Sportwetten?",
    },
    answer: {
      ...
      de: "1X2 ist der gebräuchlichste Wetttyp im Fußball. Die '1' steht für einen Heimsieg, das 'X' für ein Unentschieden und die '2' für einen Auswärtssieg. Diese Wette basiert auf dem Ergebnis nach der regulären Spielzeit (90 Minuten plus Nachspielzeit), ohne Verlängerung oder Elfmeterschießen. Sie ist ein idealer Einstieg für Anfänger, da sie einfach zu verstehen und bei jedem WM-Spiel verfügbar ist.",
    },
    category: "betting",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Wie werden die Prognosen auf dieser Website berechnet?",
    },
    answer: {
      ...
      de: "Unsere Prognosen basieren auf einem statistischen Modell, das das ELO-Bewertungssystem für Nationalmannschaften verwendet. Dieses System weist jeder Mannschaft einen numerischen Wert auf Basis ihrer historischen Leistungen zu und gewichtet jüngere Spiele und offizielle Wettbewerbe stärker. Das Modell berücksichtigt die relative Stärke der Teams, Heimvorteil, aktuelle Form und historische Direktvergleiche. Die Wahrscheinlichkeiten werden anschließend in implizite Quoten umgerechnet, um den Vergleich mit Wettanbieter-Quoten zu erleichtern.",
    },
  ...
  },
  {
    ...
    question: {
      ...
      de: "Was ist das ELO-Rating im Fußball?",
    },
    answer: {
      ...
      de: "Das ELO-Rating ist ein Bewertungssystem, das ursprünglich für Schach von Arpad Elo entwickelt wurde. Im Fußball angewendet, wird jeder Nationalmannschaft ein numerischer Wert zugewiesen, der sich nach jedem Spiel entsprechend Ergebnis, Spielwichtigkeit und Gegnerstärke verändert. Ein Sieg gegen ein stärker bewertetes Team bringt mehr Punkte als gegen ein schwächeres. Das System gilt als zuverlässiger als die offizielle FIFA-Weltrangliste für die Ergebnisvorhersage, da es Siegmargen und Spielkontext besser einbezieht.",
    },
    category: "predictions",
  },
  {
    ...
    question: {
      ...
      de: "Welche Mannschaften sind die Favoriten bei der WM 2026?",
    },
    answer: {
      ...
      de: "Laut Wettanbietern und unserem ELO-Modell zählen Brasilien, Argentinien (Titelverteidiger), Frankreich, England und Spanien (amtierender Europameister) zu den Hauptfavoriten der WM 2026. Deutschland, die Niederlande und Portugal gelten ebenfalls als ernsthafte Anwärter. Die Gastgebernationen (USA, Mexiko, Kanada) profitieren vom Heimvorteil und könnten für Überraschungen sorgen. Besuchen Sie unsere Prognoseseiten für aktualisierte Quoten zu jeder Mannschaft.",
    },
    category: "predictions",
  },
  {
    ...
    question: {
      ...
      de: "Wie genau sind KI-gestützte Prognosen?",
    },
    answer: {
      ...
      de: "Statistische und KI-Modelle wie unseres haben langfristig eine höhere Genauigkeit als menschliche Experten bewiesen. Bei den jüngsten Weltmeisterschaften haben ELO-basierte Modelle rund 50 bis 55 % der Einzelspielergebnisse korrekt vorhergesagt, was angesichts der Unberechenbarkeit des Fußballs beachtlich ist. Kein Modell ist jedoch unfehlbar: Überraschungen gehören zum Charme des Turniers. Unsere Prognosen sind ein Entscheidungshilfsmittel, keine Ergebnisgarantie. Nutzen Sie sie ergänzend zu Ihrer eigenen Analyse und wetten Sie stets verantwortungsvoll.",
    },
    category: "predictions",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Welche Länder haben sich für die WM 2026 qualifiziert?",
    },
    answer: {
      ...
      de: "Die 48 Plätze verteilen sich auf die Konföderationen wie folgt: UEFA (Europa) 16 Plätze, CAF (Afrika) 9,5, CONMEBOL (Südamerika) 6,5, AFC (Asien) 8,5, CONCACAF (Nord- und Mittelamerika) 6,5 und OFC (Ozeanien) 1,5. Die halben Plätze werden über interkontinentale Playoffs entschieden. Die drei Gastgebernationen (USA, Mexiko, Kanada) sind automatisch qualifiziert. Die vollständige Liste der qualifizierten Teams finden Sie auf unserer Mannschaftsseite, die laufend aktualisiert wird.",
    },
    category: "teams",
  },
  {
    ...
    question: {
      ...
      de: "Wie wurden die Gruppen der WM 2026 ausgelost?",
    },
    answer: {
      ...
      de: "Die Auslosung der WM 2026 fand im Dezember 2025 statt und verteilte die 48 Teams auf 12 Gruppen zu je 4 Mannschaften. Die Teams wurden anhand der FIFA-Weltrangliste in 4 Töpfe eingeteilt. Topf 1 enthielt die drei Gastgebernationen (USA, Mexiko, Kanada) und die 9 am höchsten platzierten Teams. Geografische Beschränkungen verhinderten, dass zwei Teams aus derselben Konföderation (außer der UEFA) in einer Gruppe landeten, und maximal zwei europäische Teams pro Gruppe waren erlaubt.",
    },
    category: "teams",
  },
  {
    ...
    answer: {
      ...
      de: "Im Format mit 48 Teams und 12 Gruppen qualifizieren sich die beiden Gruppenerstplatzierten (24 Teams) automatisch fürs Achtelfinale. Die 8 besten Gruppendrittplatzierten aus allen Gruppen vervollständigen das Tableau. Die Drittplatzierten werden nach folgenden Kriterien gereiht: Gesamtpunkte, Tordifferenz, erzielte Tore und zuletzt Fair-Play-Wertung (Karten). Dieses System, das bereits bei WMs mit 24 Teams (1986-1994) und bei der Europameisterschaft eingesetzt wurde, stellt sicher, dass die stärksten Teams selbst vom dritten Platz aus weiterkommen.",
    },
    category: "teams",
  },
  {
    ...
    question: {
      ...
      de: "Welche Gastgebernationen gibt es und welchen Vorteil haben sie?",
    },
    answer: {
      ...
      de: "Die USA, Mexiko und Kanada sind die drei Gastgebernationen der WM 2026. Als Ausrichterländer qualifizieren sich ihre Nationalmannschaften automatisch ohne den Umweg über die Qualifikation. Historisch gesehen profitieren Gastgeber von einem erheblichen Vorteil: Heimsupport, keine Reisebeschwerden und Vertrautheit mit den lokalen Bedingungen. Seit 1930 schied kein Gastgeberland in der Gruppenphase aus, außer Südafrika 2010. Mexiko spielt in Gruppe A, die USA in Gruppe D und Kanada in Gruppe B.",
    },
    category: "teams",
  },
  {
    ...
    question: {
      ...
      de: "Wie sind die Chancen der deutschen Nationalmannschaft bei der WM 2026?",
    },
    answer: {
      ...
      de: "Die deutsche Nationalmannschaft gehört zu den ernsthaften Titelanwärtern bei der WM 2026. Nach dem EM-Halbfinale 2024 im eigenen Land verfügt das DFB-Team unter Bundestrainer Julian Nagelsmann über eine vielversprechende Generation mit Spielern wie Florian Wirtz, Jamal Musiala und Kai Havertz. Als viermaliger Weltmeister (1954, 1974, 1990, 2014) tritt Deutschland stets mit hohen Ambitionen auf. Wettanbieter sehen die Deutschen als Außenseiter mit ernsthaften Titelchancen, mit Quoten zwischen 8,00 und 12,00.",
    },
    category: "teams",
  },
  {
    ...
    question: {
      ...
      de: "Welche Außenseiter könnten bei der WM 2026 überraschen?",
    },
    answer: {
      ...
      de: "Mehrere Mannschaften könnten bei der WM 2026 für Überraschungen sorgen. Die USA als Hauptgastgeber mit einer goldenen Generation (Pulisic, McKennie, Reyna, Musah) sind ernsthafte Kandidaten für einen historischen Turnierlauf. Japan, bei den jüngsten Turnieren stark aufgetreten, verbessert sich kontinuierlich mit Spielern in den europäischen Topligen. Nigeria und Marokko könnten ebenfalls überraschen. Kolumbien mit Luis Díaz und Kanada als Gastgebernation sind Teams, die man genau beobachten sollte.",
    },
    category: "teams",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Auf welchem Sender kann man die WM 2026 in Deutschland schauen?",
    },
    answer: {
      fr: "En France, les droits de diffusion de la Coupe du Monde 2026 sont détenus par M6 et beIN Sports. M6 diffuse en clair 54 matchs dont tous les matchs de l'équipe de France, le match d'ouverture, les quarts, demi-finales et la finale. beIN Sports propose l'intégralité des 104 matchs en direct pour ses abonnés. Il est possible de suivre les matchs en streaming via M6+ (gratuit) et beIN CONNECT (abonnement). TF1 ne diffuse aucun match de cette édition. Attention au décalage horaire : les matchs joués aux États-Unis ont lieu en soirée et en début de nuit, heure française.",
      en: "In France, the 2026 World Cup broadcasting rights are held by M6 and beIN Sports. M6 broadcasts 54 matches free-to-air including all France matches, the opening match, semi-finals and the final. beIN Sports offers all 104 matches for subscribers. Streaming is available via M6+ (free) and beIN CONNECT. TF1 has no matches for this edition.",
      es: "En Francia, los derechos de transmisión del Mundial 2026 los tienen M6 y beIN Sports. M6 emite en abierto 54 partidos incluyendo los de Francia, las semifinales y la final. beIN Sports ofrece los 104 partidos para suscriptores. TF1 no emite ningún partido de esta edición.",
      de: "In Deutschland übertragen ARD und ZDF ausgewählte WM-Spiele 2026 kostenlos im Free-TV, darunter alle Spiele der deutschen Nationalmannschaft, das Eröffnungsspiel, die Halbfinals und das Finale. MagentaTV (Telekom) zeigt alle 104 Spiele live für Abonnenten. Livestreams sind über ARD Mediathek und ZDF Mediathek kostenlos abrufbar. Beachten Sie die Zeitverschiebung: Spiele in den USA und Mexiko finden in der Regel abends und nachts mitteleuropäischer Zeit statt.",
    },
    category: "watching",
  },
  {
    ...
    question: {
      ...
      de: "Kann man die WM 2026 kostenlos per Livestream schauen?",
    },
    answer: {
      fr: "Oui, il est possible de regarder 54 matchs de la Coupe du Monde 2026 gratuitement en streaming depuis la France. M6 diffuse les matchs en clair (équipe de France, grandes affiches, demi-finales, finale) sur sa plateforme M6+ accessible gratuitement sur ordinateur, smartphone et tablette. Pour les autres matchs, un abonnement beIN Sports est nécessaire. Méfiez-vous des sites de streaming illégaux qui présentent des risques de sécurité informatique et de qualité médiocre.",
      en: "Yes, 54 World Cup 2026 matches can be watched for free via streaming from France. M6 broadcasts major matches on its free M6+ platform. For other matches, a beIN Sports subscription is required. Beware of illegal streaming sites that pose security risks.",
      es: "Sí, 54 partidos del Mundial 2026 se pueden ver gratis en streaming desde Francia. M6 emite los partidos principales en su plataforma gratuita M6+. Para otros partidos se necesita suscripción a beIN Sports.",
      de: "Ja, ausgewählte WM-2026-Spiele können in Deutschland kostenlos per Livestream verfolgt werden. ARD und ZDF übertragen ihre Spiele kostenfrei über ARD Mediathek und ZDF Mediathek auf PC, Smartphone und Tablet. Für alle 104 Spiele ist ein MagentaTV-Abonnement erforderlich. Vorsicht vor illegalen Streaming-Seiten, die Sicherheitsrisiken darstellen und oft schlechte Qualität liefern.",
    },
    category: "watching",
  },
  {
    ...
    question: {
      ...
      de: "Zu welchen Uhrzeiten finden die WM-2026-Spiele in deutscher Zeit statt?",
    },
    answer: {
      ...
      de: "Die WM-2026-Spiele finden hauptsächlich in den USA, Kanada und Mexiko statt, mit einer Zeitverschiebung von 6 bis 9 Stunden gegenüber Mitteleuropa (Sommerzeit). Gruppenspiele beginnen typischerweise um 18 Uhr, 21 Uhr und Mitternacht MEZ. K.o.-Runden-Spiele sind meist zwischen 21 Uhr und 3 Uhr morgens MEZ angesetzt. Planen Sie Ihre Abende entsprechend, denn manche Begegnungen werden erst spät in der Nacht angepfiffen.",
    },
    category: "watching",
  },
  {
    ...
    question: {
      ...
      de: "Wo kann man die WM-2026-Spiele in einer Bar in Deutschland schauen?",
    },
    answer: {
      ...
      de: "Viele Kneipen, Sportsbars und Restaurants in Deutschland werden WM-2026-Spiele übertragen, besonders die Spiele der deutschen Nationalmannschaft. Sportkneipen und Fußball-Bars sind die besten Orte für gemeinsames Erleben. In großen Städten wie Berlin, München, Hamburg und Köln gibt es bekannte Anlaufstellen für Public-Viewing-Events. Reservieren Sie Ihren Platz für DFB-Spiele frühzeitig, da diese schnell ausgebucht sind. In vielen Städten könnten zudem offizielle Fan-Zonen eingerichtet werden.",
    },
    category: "watching",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Braucht man ein Visum, um die WM 2026 in den USA zu besuchen?",
    },
    answer: {
      ...
      de: "Deutsche Staatsbürger benötigen für touristische Aufenthalte von unter 90 Tagen in den USA kein Visum dank des ESTA-Programms (Electronic System for Travel Authorization). ESTA kostet 21 US-Dollar und muss mindestens 72 Stunden vor der Abreise online beantragt werden. Für Mexiko ist ebenfalls kein Visum erforderlich. Für Kanada genügt eine eTA (Electronic Travel Authorization). Stellen Sie sicher, dass Ihr Reisepass noch mindestens 6 Monate über Ihre geplante Rückkehr hinaus gültig ist.",
    },
    category: "travel",
  },
  {
    ...
    question: {
      ...
      de: "Wie kauft man Tickets für die WM 2026?",
    },
    answer: {
      ...
      de: "Tickets für die WM 2026 werden ausschließlich über die offizielle FIFA-Website (FIFA.com/tickets) verkauft. Die Verkaufsphasen umfassen eine erste Losziehungsphase, gefolgt von einem Verkauf nach Eingang der Bestellung. Die Preise variieren je nach Kategorie und Turnierrunde, von etwa 50 Dollar für Gruppenspiele in Kategorie 4 bis über 1.500 Dollar für das Finale in Kategorie 1. Die FIFA bietet auch Pakete zum Verfolgen einer bestimmten Nationalmannschaft an. Kaufen Sie niemals Tickets bei nicht autorisierten Wiederverkäufern.",
    },
    category: "travel",
  },
  {
    ...
    question: {
      ...
      de: "Welches Budget sollte man für einen WM-2026-Besuch aus Deutschland einplanen?",
    },
    answer: {
      ...
      de: "Ein WM-2026-Besuch aus Deutschland erfordert eine erhebliche Investition. Rechnen Sie mit etwa 800 bis 1.500 Euro für einen Hin- und Rückflug in die USA, je nach Stadt und Reisezeitraum. Die Unterkunft kostet 100 bis 300 Euro pro Nacht im Hotel (die Preise steigen während des Turniers deutlich). Spieltickets kosten durchschnittlich 50 bis 300 Euro. Hinzu kommen Verpflegung (30 bis 60 Euro/Tag), lokaler Transport und Freizeitaktivitäten. Ein realistisches Budget für eine Woche mit 2 bis 3 Spielen liegt bei 3.000 bis 6.000 Euro pro Person. Buchen Sie Flüge und Unterkünfte so früh wie möglich.",
    },
    category: "travel",
  },
  {
    ...
    question: {
      ...
      de: "Wo kann man während der WM 2026 übernachten?",
    },
    answer: {
      ...
      de: "Mehrere Unterkunftsoptionen stehen WM-Besuchern zur Verfügung. Hotels sind die klassische Lösung, werden aber während des Events deutlich teurer: Buchen Sie mindestens 6 Monate im Voraus. Airbnb- und VRBO-Mietobjekte bieten oft ein besseres Preis-Leistungs-Verhältnis, besonders für Gruppen. Für knappes Budget gibt es Hostels in allen US-Austragungsstädten. Manche Fans wählen günstigere Nachbarstädte mit guter Verkehrsanbindung. Die FIFA wird auch offizielle Hospitality-Pakete mit Unterkunft und Tickets anbieten.",
    },
    category: "travel",
  },
  {
    ...
    question: {
      ...
      de: "Wie reist man zwischen den WM-2026-Austragungsstädten?",
    },
    answer: {
      ...
      de: "Die Abstände zwischen den Austragungsstädten der WM 2026 sind erheblich, denn die USA sind ein Kontinent. Inlandsflüge sind das wichtigste Transportmittel zwischen weit entfernten Städten; günstige Anbieter wie Southwest, Spirit und Frontier bieten erschwingliche Inlandsflüge. Für nahegelegene Städte (z. B. New York-Philadelphia-Boston) sind Amtrak-Züge oder Mietwagen sinnvolle Alternativen. Innerhalb der Städte stehen Metro, Busse und Fahrdienstleister (Uber, Lyft) zur Verfügung. Spezielle Stadienshuttles werden voraussichtlich von den Organisatoren eingerichtet. Planen Sie Ihre Transfers im Voraus und buchen Sie Inlandsflüge frühzeitig.",
    },
    category: "travel",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Welche Länder haben die FIFA-Weltmeisterschaft gewonnen?",
    },
    answer: {
      ...
      de: "Seit der ersten Ausgabe 1930 haben acht Nationen die FIFA-Weltmeisterschaft gewonnen. Brasilien führt mit 5 Titeln (1958, 1962, 1970, 1994, 2002), gefolgt von Deutschland und Italien mit je 4 Titeln. Argentinien hat 3 Siege (1978, 1986, 2022), Frankreich und Uruguay je 2, England (1966) und Spanien (2010) je einen. Argentinien ist der amtierende Weltmeister nach dem epischen Finale 2022 gegen Frankreich in Katar, das als eines der schönsten Endspiele der Geschichte gilt.",
    },
    category: "history",
  },
  {
    ...
    question: {
      ...
      de: "Wie ist die WM-Bilanz Deutschlands?",
    },
    answer: {
      ...
      de: "Deutschland gehört zu den erfolgreichsten Nationen der WM-Geschichte mit vier Titeln (1954, 1974, 1990, 2014). 1954 gelang das \"Wunder von Bern\" gegen Ungarn, 1974 gewann die Mannschaft als Gastgeber. 1990 triumphierte die DFB-Elf 1:0 gegen Argentinien in Rom. 2014 in Brasilien folgte der bisher letzte Titel mit dem legendären 7:1-Halbfinalsieg gegen den Gastgeber und dem 1:0-Finalsieg gegen Argentinien durch Mario Götze. Zuletzt schied Deutschland bei der WM 2022 in der Gruppenphase aus, was den Anstoß zu einer Erneuerung des DFB-Teams gab.",
    },
    category: "history",
  },
  {
    ...
    question: {
      ...
      de: "Welche Rekorde gibt es bei der FIFA-Weltmeisterschaft?",
    },
    answer: {
      ...
      de: "Die Weltmeisterschaft ist reich an faszinierenden Rekorden. Miroslav Klose (Deutschland) ist mit 16 Toren in vier Turnieren der erfolgreichste Torschütze aller Zeiten. Pelé ist der einzige dreifache Weltmeister (1958, 1962, 1970). Das torreichste Spiel war Österreich gegen die Schweiz 7:5 im Jahr 2014. Deutschland hält mit dem 7:1 gegen Brasilien im Halbfinale 2014 den Rekord für den höchsten Sieg in einem Halbfinale. Der jüngste WM-Torschütze ist Pelé mit 17 Jahren und 239 Tagen. Lionel Messi hält den Rekord für die meisten Einsätze (26). Das WM-2026-Format dürfte einige dieser Rekorde brechen.",
    },
    category: "history",
  },
  {
    ...
    question: {
      ...
      de: "Wo und wann fand die erste FIFA-Weltmeisterschaft statt?",
    },
    answer: {
      ...
      de: "Die erste Weltmeisterschaft fand 1930 in Uruguay statt, auf Initiative des FIFA-Präsidenten Jules Rimet. Nur 13 Teams nahmen teil. Alle Spiele wurden in Montevideo ausgetragen, hauptsächlich im eigens errichteten Estadio Centenario. Uruguay gewann den ersten Titel mit einem 4:2-Sieg gegen Argentinien im Finale vor rund 93.000 Zuschauern. Mehrere europäische Mannschaften hatten die Einladung wegen der langen Schiffsreise nach Südamerika abgelehnt. Seit dieser ersten Ausgabe ist die Weltmeisterschaft zum meistgesehenen Sportereignis der Welt geworden.",
    },
    category: "history",
  },
  {
    ...
    question: {
      ...
      de: "Wie hat sich das Format der Weltmeisterschaft im Laufe der Jahre entwickelt?",
    },
    answer: {
      ...
      de: "Das Format der Weltmeisterschaft hat sich seit 1930 erheblich gewandelt: 13 Teams 1930, 16 von 1934 bis 1978, 24 von 1982 bis 1994, 32 von 1998 bis 2022 und nun 48 für 2026. Die Ausgabe 2026 umfasst 12 Gruppen und insgesamt 104 Spiele, die größte Formatänderung in der Geschichte der Weltmeisterschaft. Diese Entwicklung spiegelt die Globalisierung des Fußballs und den Wunsch der FIFA wider, mehr Nationen einzubeziehen.",
    },
    category: "history",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Welche legalen Wettanbieter sind in Deutschland für die WM 2026 die besten?",
    },
    answer: {
      ...
      de: "In Deutschland dürfen nur Anbieter mit einer Lizenz der Gemeinsamen Glücksspielbehörde der Länder (GGL) Sportwetten online anbieten. Zu den führenden legalen Wettanbietern zählen Betano, Tipico, bet365 und Bwin. Jeder bietet unterschiedliche Willkommensaktionen an: Gratiswetten, Einzahlungsbonusse oder Wettguthaben. Zur WM 2026 werden diese Anbieter spezielle Promotionen auflegen. Vergleichen Sie die Quoten zwischen mehreren Seiten, da die Unterschiede auf manchen Märkten 5 bis 10 % betragen können. Achten Sie stets auf eine gültige GGL-Lizenz, bevor Sie sich registrieren.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Wie wettet man verantwortungsvoll auf die WM 2026?",
    },
    answer: {
      ...
      de: "Verantwortungsvolles Spielen ist entscheidend, um die WM 2026 ohne finanzielles Risiko zu genießen. Legen Sie vor dem Turnier ein festes Budget fest und überschreiten Sie es niemals, auch nicht nach einer Gewinnserie. Setzen Sie niemals Geld, das Sie für alltägliche Ausgaben benötigen. Vermeiden Sie Wetten unter Alkoholeinfluss oder nach einem frustrierenden Spiel. Nutzen Sie die Werkzeuge GGL-lizenzierter Anbieter: Einzahlungslimits, Einsatzlimits und vorübergehende Selbstsperre. Wenn Glücksspielen zum Problem wird, wenden Sie sich an die Bundeszentrale für gesundheitliche Aufklärung (BZgA) unter 0800 1 37 27 00 (kostenlos). Denken Sie daran: Sportwetten sind Unterhaltung, kein Einkommensmodell.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Was ist eine Kombiwette und wie nutzt man sie bei der WM?",
    },
    answer: {
      ...
      de: "Eine Kombiwette fasst mehrere Einzelauswahlen in einer Wette zusammen, wobei die Quoten miteinander multipliziert werden, was höhere Gewinne ermöglicht. Während der WM sind Kombiwetten beliebt, da täglich mehrere Spiele stattfinden. Eine Beispielkombination aus drei Spielen mit Quoten von 1,50, 2,00 und 1,80 ergibt eine Gesamtquote von 5,40. Achtung: Eine einzige verlorene Auswahl verliert die gesamte Wette. Beschränken Sie sich auf maximal 3 bis 4 Auswahlen für vernünftige Gewinnchancen.",
    },
    category: "betting",
  },
  {
    ...
    question: {
      ...
      de: "Wie funktionieren Live-Wetten während eines Spiels?",
    },
    answer: {
      ...
      de: "Live-Wetten ermöglichen das Wetten während eines laufenden Spiels, wobei sich die Quoten in Echtzeit entsprechend dem Spielverlauf verändern. Bei der WM 2026 können Sie auf den nächsten Torschützen, das Endergebnis, Eckbälle, Karten und viele weitere Märkte in Echtzeit wetten. Die Quoten ändern sich bei jeder wichtigen Aktion (Tor, Rote Karte, Elfmeter). Tipp: Schauen Sie das Spiel live und nicht mit Zeitversatz, um dieselben Informationen wie der Anbieter zu haben. Alle GGL-lizenzierten Wettanbieter in Deutschland bieten Live-Wetten an.",
    },
    category: "betting",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Was ist das Maskottchen der WM 2026?",
    },
    answer: {
      ...
      de: "Die FIFA hat das offizielle Maskottchen der WM 2026 enthüllt, das den multikulturellen Geist der drei Gastgebernationen verkörpert. Jede WM-Ausgabe hat seit Willie dem Löwen 1966 in England ihr eigenes ikonisches Maskottchen. Zu den jüngsten Maskottchen zählen Zabivaka der Wolf (Russland 2018) und La'eeb (Katar 2022). Das Maskottchen 2026 wird im gesamten Turnier präsent sein: in den Stadien, auf offiziellem Merchandise und in den Kommunikationskampagnen der FIFA. Besuchen Sie FIFA.com für alle Produkte rund um das neue Maskottchen.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Wird der VAR bei der WM 2026 eingesetzt?",
    },
    answer: {
      ...
      de: "Ja, der VAR (Video Assistant Referee) wird bei der WM 2026 eingesetzt, wie seit seiner Einführung 2018 in Russland. Die FIFA könnte zudem technologische Verbesserungen einführen, wie die halbautomatische Abseitstechnologie, die 2022 in Katar erfolgreich erprobt wurde und Tracking-Kameras sowie KI für schnellere und präzisere Entscheidungen nutzt. Der vernetzte Ball aus 2022 wird ebenfalls zurückkehren. Diese Technologien sollen Schiedsrichterfehler reduzieren und Spielunterbrechungen minimieren.",
    },
    category: "tournament",
  },
  {
    ...
    question: {
      ...
      de: "Welche Preisgelder gibt es bei der WM 2026?",
    },
    answer: {
      ...
      de: "Die FIFA hat den Preisgeldfonds für die WM 2026 erheblich aufgestockt. Das Gesamtpreisgeld soll eine Milliarde Dollar übersteigen, gegenüber 440 Millionen Dollar 2022. Der Weltmeister könnte mehr als 50 Millionen Dollar erhalten, während bereits in der Gruppenphase ausgeschiedene Teams mindestens 10 bis 13 Millionen Dollar verdienen. Die Einnahmen stammen hauptsächlich aus TV-Rechten, Sponsoring und Ticketing. Die Verbände verteilen diese Mittel anschließend an Spieler, ausbildende Vereine und die Fußballentwicklung in ihrem Land.",
    },
    category: "tournament",
  },
  ...
  // ============================================================
  {
    ...
    question: {
      ...
      de: "Wie prognostiziert man Gruppenspiele?",
    },
    answer: {
      ...
      de: "Gruppenspiele sind oft am schwierigsten zu prognostizieren, da viele Begegnungen und weniger bekannte Teams aufeinandertreffen. Tipps zur Verbesserung Ihrer Prognosen: Analysieren Sie ELO- und FIFA-Rankings, studieren Sie aktuelle Qualifikationsergebnisse, berücksichtigen Sie den Heimvorteil der Gastgeber und prüfen Sie die Fitness der Schlüsselspieler. Der erste Spieltag einer Gruppe ist am unberechenbarsten. Der letzte Spieltag hingegen bietet oft klarere taktische Situationen (Sieg nötig, Unentschieden reicht). Unser ELO-Modell berücksichtigt all diese Parameter.",
    },
    category: "predictions",
  },
  {
    ...
    question: {
      ...
      de: "Wer wird der Torschützenkönig der WM 2026?",
    },
    answer: {
      ...
      de: "Das Rennen um den Goldenen Schuh 2026 ist laut Wettanbietern offen. Kylian Mbappé gilt wegen seiner Geschwindigkeit und seiner Fähigkeit, in großen Spielen zu treffen, als einer der Hauptfavoriten. Harry Kane, Erling Haaland (falls Norwegen sich qualifiziert), Vinícius Júnior und Lautaro Martínez sind ebenfalls gut positioniert. Historisch gesehen kommen die Torschützenkönige oft aus Teams, die weit ins Turnier vordringen. Das erweiterte Format auf 48 Teams gibt Topstürmern mehr potenzielle Spiele. Seit 2002 hat kein Torschützenkönig mehr als 6 Tore erzielt, doch der Rekord von Just Fontaine (13 Tore 1958) könnte mit dem neuen Format in Gefahr geraten.",
    },
    category: "predictions",
  },
];
