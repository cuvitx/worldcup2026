...
// FIFA Rankings as of June 11, 2026 (official FIFA/Coca-Cola Men's World Ranking)
...
export const teams: Team[] = [
  ...
  },
  {
    ...
    isHost: false,
    wcAppearances: 7,
    bestResult: "Finaliste (1934, 1962)",
    description: "La Tchéquie (anciennement Tchécoslovaquie puis République tchèque) retrouve la Coupe du monde après avoir manqué les éditions 2018 et 2022. Double finaliste historique sous le nom de Tchécoslovaquie (1934 et 1962), la sélection tchèque a atteint les demi-finales de l'Euro 2004 et la finale de l'Euro 1996. Qualifiée via les barrages UEFA en battant le Danemark aux tirs au but, la Tchéquie s'appuie sur un effectif mêlant expérience et jeunesse. Le style de jeu tchèque privilégie l'organisation défensive, la rigueur tactique et les transitions rapides. Le championnat tchèque produit régulièrement des talents qui s'exportent en Bundesliga, en Premier League et en Serie A. Cette participation au Mondial 2026 est vécue comme un renouveau pour le football tchèque, qui espère retrouver les sommets européens.",
  },
  ...
  },
  {
    ...
    isHost: false,
    wcAppearances: 2,
    bestResult: "Phase de groupes (2014)",
    description: "La Bosnie-Herzégovine dispute sa deuxième Coupe du monde après une première participation au Brésil en 2014. Qualifiée via les barrages UEFA en éliminant l'Italie aux tirs au but lors d'une finale dramatique, la sélection bosnienne a créé l'une des plus grandes surprises des qualifications. Le football bosnien, né après l'indépendance du pays en 1992, a connu une progression remarquable portée par une génération dorée incluant Edin Džeko, Miralem Pjanić et leurs successeurs. Le style de jeu bosnien allie combativité physique, solidité défensive et qualité technique au milieu de terrain. Cette qualification historique aux dépens de l'Italie a provoqué une explosion de joie dans tout le pays et nourrit l'espoir de franchir enfin la phase de groupes d'un Mondial.",
  },
  ...
  },
  {
    ...
    isHost: false,
    wcAppearances: 3,
    bestResult: "Troisième (2002)",
    description: "La Turquie retrouve la Coupe du monde pour la première fois depuis sa remarquable troisième place en 2002 en Corée du Sud/Japon. Absente des Mondiaux 2006, 2010, 2014, 2018 et 2022, la sélection turque a traversé une longue période de disette avant de se qualifier via les barrages UEFA en battant le Kosovo 1-0. La Turquie de 2002 avait marqué les esprits avec des joueurs comme Hakan Şükür, İlhan Mansız et Rüştü Reçber. La nouvelle génération, portée par des talents évoluant dans les plus grands clubs européens, espère rééditer cet exploit. Le football turc, soutenu par un public parmi les plus passionnés au monde et un championnat national de plus en plus compétitif, revient sur la scène mondiale avec l'ambition de surprendre dans un Groupe D relevé avec les États-Unis, le Paraguay et l'Australie.",
  },
  ...
  },
  {
    ...
    isHost: false,
    wcAppearances: 13,
    bestResult: "Finaliste (1958)",
    description: "La Suède retrouve la Coupe du monde après avoir manqué l'édition 2022 au Qatar. Finaliste à domicile en 1958 et troisième en 1994, la sélection suédoise possède un palmarès prestigieux dans la compétition. Qualifiée via les barrages UEFA en battant la Pologne 3-2 en finale, la Suède confirme sa capacité à performer dans les matchs décisifs. Le football suédois, caractérisé par une organisation collective irréprochable et une puissance physique, a toujours su rivaliser avec les plus grandes nations. Après l'ère Zlatan Ibrahimović, une nouvelle génération portée par des talents évoluant dans les grands championnats européens porte les espoirs de la nation scandinave. Le groupe F avec les Pays-Bas, le Japon et la Tunisie représente un défi relevable pour les Blågult.",
  },
  ...
  },
  {
    ...
    isHost: false,
    wcAppearances: 2,
    bestResult: "Phase de groupes (1986)",
    description: "L'Irak retrouve la Coupe du monde pour la première fois depuis 1986, soit 40 ans d'absence. Qualifié via les barrages intercontinentaux en battant la Bolivie 2-1, l'Irak réalise un exploit historique pour un pays dont le football a été profondément affecté par des décennies de conflits. Vainqueur de la Coupe d'Asie 2007 dans des circonstances exceptionnelles, au milieu d'une guerre civile, le football irakien symbolise la résilience d'un peuple. La sélection actuelle, portée par une jeune génération talentueuse et l'attaquant vedette Aymen Hussein, a su surmonter les difficultés pour décrocher ce billet mondial. L'Irak affrontera la France, le Sénégal et la Norvège dans le Groupe I, avec l'ambition de montrer au monde le renouveau du football irakien.",
  },
  ...
  },
  {
    ...
    wcAppearances: 2,
    bestResult: "Phase de groupes (1974)",
    description: "La République démocratique du Congo retrouve la Coupe du monde pour la première fois depuis 1974, où elle avait participé sous le nom de Zaïre. Cette qualification historique via les barrages intercontinentaux, obtenue grâce à un but d'Axel Tuanzebe à la 100e minute contre la Jamaïque, marque le retour d'une des plus grandes nations du football africain. La RD Congo, vainqueur de deux Coupes d'Afrique des Nations (1968, 1974), possède un vivier de talents considérable puisant dans une diaspora présente dans les plus grands championnats européens. L'effectif actuel mêle des joueurs de la Premier League, de la Ligue 1 et de la Bundesliga. Le style de jeu congolais, athlétique et technique, promet d'animer le Groupe K aux côtés du Portugal, de la Colombie et de l'Ouzbékistan.",
  },
