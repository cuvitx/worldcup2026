...
export function generateMetadata(): Metadata {
  return {
    ...
    openGraph: {
      ...
      url: "https://www.cdm2026.fr/plan-du-site/equipe",
    },
    alternates: { canonical: "https://www.cdm2026.fr/plan-du-site/equipe" },
  };
}
          ...
          <section key={group.letter}>
            ...
            <div className="mt-4 space-y-3">
              {group.teams.map((teamId) => {
                ...
                if (!team) return null;
                return (
                  <div key={team.id} className="border-b border-gray-100 pb-2">
