            ...
            >
              <details className="group">
                <summary className="flex cursor-pointer items-center justify-between px-5 py-4 text-sm font-semibold text-gray-900 hover:text-primary transition-colors list-none">
                  {item.question}
                  <span className="ml-4 shrink-0 w-6 h-6 rounded-full bg-gray-100gray-700 flex items-center justify-center text-gray-600 group-open:rotate-45 transition-transform duration-200">
