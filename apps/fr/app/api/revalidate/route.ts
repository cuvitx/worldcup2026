 ...
 *
 * Body: { "paths": ["/match/france-vs-senegal", ...] }
...
export async function POST(request: NextRequest) {
  ...
  if (body.all) {
    ...
    revalidatePath("/match/calendrier");
    revalidatePath("/match/aujourdhui");
    revalidatePath("/groupes");
    revalidatePath("/");
    revalidated.push("/match (all)", "/match/calendrier", "/match/aujourdhui", "/groupes", "/");
