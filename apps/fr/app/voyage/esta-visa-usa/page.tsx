...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.cdm2026.fr/voyage/esta-visa-usa",
  },
  alternates: { canonical: "https://www.cdm2026.fr/voyage/esta-visa-usa" },
};
...
<Breadcrumb
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { href: "/voyage/visa-mexique", icon: "🇲🇽", title: "Formalités Mexique", desc: "FMM, documents nécessaires et conseils pour les matchs au Mexique." },
              { href: "/voyage/formalites-canada", icon: "🇨🇦", title: "Formalités Canada (AVE)", desc: "Autorisation de Voyage Électronique pour les matchs à Vancouver et Toronto." },
              { href: "/billets", icon: "", title: "Billets CDM 2026", desc: "Prix, dates de vente et comment acheter ses places sur FIFA.com." },
              { href: "/voyage/assurance", icon: "", title: "Assurance voyage", desc: "Comparatif des assurances voyage pour la CDM 2026." },
            ].map((link) => (
