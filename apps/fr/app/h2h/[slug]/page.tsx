        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-4 text-center md:flex-row md:justify-center md:gap-8">
            <div className="flex flex-col items-center">
              ...
              <Link href={`/equipe/${team1.slug}`} className="mt-2 text-2xl font-extrabold text-white hover:text-accent">
                {team1.name}
              </Link>
            ...
            <div className="flex flex-col items-center">
              ...
              <Link href={`/equipe/${team2.slug}`} className="mt-2 text-2xl font-extrabold text-white hover:text-accent">
                {team2.name}
              </Link>
