    ...
    <>
      ...
      <section className="bg-white dark:bg-slate-900 py-8">
        <div className="mx-auto max-w-3xl px-4">
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 px-6 py-5 text-center shadow-sm">
            <div className="inline-flex items-center gap-2 rounded-full bg-gray-100 dark:bg-gray-700 px-4 py-1.5 text-gray-700 dark:text-gray-300 font-semibold text-sm mb-3">
