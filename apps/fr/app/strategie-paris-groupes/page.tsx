  ...
  return (
    <>
      <BreadcrumbSchema
        items={[
          { name: "Accueil", url: "/" },
          { name: "Stratégie paris groupes", url: "/strategie-paris-groupes" },
        ]}
        baseUrl={domains.fr}
      />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-14">
        ...
        <div className="text-center">
          <Link href="/paris-handicap" className="inline-flex items-center gap-2 bg-accent text-white rounded-xl py-3.5 px-8 font-semibold hover:opacity-90 transition-opacity">
