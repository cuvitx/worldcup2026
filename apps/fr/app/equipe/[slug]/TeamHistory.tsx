          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {history.yearsParticipated.map((year) => (
                <span key={year} className="rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primaryprimary/20">
                  {year}
                </span>
              ))}
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-4">
              {titles.map((title) => (
                <div key={title.year} className="flex flex-col items-center rounded-xl bg-primary/10secondary/20 border border-primary/40 px-5 py-4 min-w-[110px] text-center">
                  ...
                  {title.detail && (
                    <span className="mt-1 text-xs text-gray-600 leading-snug max-w-[120px]">{title.detail}</span>
                  )}
                </div>
              ))}
            </div>
