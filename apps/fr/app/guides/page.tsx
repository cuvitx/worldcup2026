      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-10">
        ...
        <section className="rounded-xl bg-white p-6 shadow-sm border border-gray-100">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { href: "/esta-usa", icon: "🛂", title: "ESTA pour les USA", description: "Obtenir votre autorisation de voyage pour les États-Unis" },
              { href: "/visa-mexique", icon: "🇲🇽", title: "Visa Mexique", description: "Formalités pour entrer au Mexique" },
              { href: "/formalites-canada", icon: "🇨🇦", title: "Formalités Canada", description: "AVE et documents pour le Canada" },
              { href: "/decalage-horaire", icon: "🕐", title: "Décalage horaire", description: "Horaires des matchs depuis la France" },
              ...
              { href: "/assurance-voyage", icon: "🛡️", title: "Assurance voyage", description: "Quelle assurance choisir pour les USA" },
              { href: "/carte-sim-usa", icon: "📱", title: "Carte SIM USA", description: "Rester connecté aux États-Unis" },
              { href: "/valise-cdm", icon: "🧳", title: "Que mettre dans sa valise", description: "Checklist pour ne rien oublier" },
              { href: "/pourboires-usa", icon: "💵", title: "Pourboires aux USA", description: "Guide des pourboires aux États-Unis" },
              { href: "/supporter-francais-usa", icon: "🇫🇷", title: "Supporter français aux USA", description: "Conseils pour les supporters français" },
              { href: "/wifi-stades", icon: "📶", title: "WiFi dans les stades", description: "Connexion internet dans les stades CDM" },
              { href: "/alcool-stades", icon: "🍺", title: "Alcool dans les stades", description: "Réglementation sur l'alcool dans les stades" },
              ...
              { href: "/calculateur-budget", icon: "🧮", title: "Calculateur de budget", description: "Calculez votre budget CDM personnalisé" },
            ].map(item => (
