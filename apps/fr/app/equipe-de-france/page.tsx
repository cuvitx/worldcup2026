...
export const metadata: Metadata = {
  ...
  description:
    "Tout sur l'équipe de France à la Coupe du Monde 2026 : effectif des Bleus, calendrier des matchs, pronostics, historique CDM (1998, 2018, 2022) et analyse complète.",
  openGraph: {
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-gray-200 max-w-2xl leading-relaxed mb-6 text-sm md:text-base">
                Double championne du monde (1998, 2018), finaliste en 2022, la France est
                l&apos;un des grands favoris de la CDM 2026. Groupe I · MetLife, Philadelphia, Boston.
              </p>
