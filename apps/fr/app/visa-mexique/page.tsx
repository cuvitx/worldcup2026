...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.cdm2026.fr/visa-mexique",
  },
  alternates: { canonical: "https://www.cdm2026.fr/visa-mexique" },
};
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <section>
          ...
          <ul className="space-y-2 text-secondary text-sm">
            ...
            <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-green-500 shrink-0 mt-0.5" /> <span><strong>Assurance :</strong> Souscrivez une <Link href="/assurance-voyage" className="text-accent underline">assurance voyage</Link> couvrant les frais médicaux</span></li>
          </ul>
        </section>
