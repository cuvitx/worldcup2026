...
export const metadata: Metadata = {
  ...
  description:
    "Comparez les cotes de PokerStars Sports, Betsson, PMU Sport et Genybet pour tous les matchs de la phase de groupes de la Coupe du Monde 2026. Trouvez la meilleure cote.",
  openGraph: {
