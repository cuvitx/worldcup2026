...
export const metadata: Metadata = {
  title: "Horaires des matchs - Coupe du Monde 2026",
  description:
    "Tous les horaires des 104 matchs de la Coupe du Monde 2026 en heure fran\u00e7aise (Europe/Paris). Planning complet du 11 juin au 19 juillet 2026 avec fuseaux horaires.",
  alternates: {
    canonical: "https://www.cdm2026.fr/horaires",
  },
  openGraph: {
    title: "Horaires des matchs - Coupe du Monde 2026",
    description:
      "Planning complet des 104 matchs de la CDM 2026 en heure fran\u00e7aise. Fuseaux horaires, stades et villes.",
    url: "https://www.cdm2026.fr/horaires",
  },
};
      ...
      <section className="hero-animated text-white py-12 sm:py-16">
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl font-extrabold sm:text-4xl">
            Horaires des matchs &mdash; Coupe du Monde 2026
          </h1>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-10 border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-gray-600 mb-6">
            La Coupe du Monde 2026 se d\u00e9roule sur 3 pays et 3 fuseaux horaires
      ...
      <section className="bg-gray-50 py-12 border-t border-gray-100">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-4">
            <p>
              La Coupe du Monde 2026 est la premi\u00e8re \u00e9dition organis\u00e9e sur{" "}
