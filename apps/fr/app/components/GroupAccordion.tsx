      ...
      <div className="md:hidden">
        ...
        {!isExpanded && (
          <button
            ...
            className="mt-4 w-full rounded-lg border border-gray-200 bg-white py-3 text-center font-semibold text-accent transition-colors hover:bg-accent/5 min-h-[44px]"
          >
