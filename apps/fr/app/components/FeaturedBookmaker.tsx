      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mx-auto max-w-2xl rounded-xl border-2 border-yellow-500/60 bg-gradient-to-br from-yellow-50 to-white p-6 shadow-md dark:from-yellow-950/20 dark:to-slate-800 dark:border-yellow-600/40">
          <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
            {/* Logo placeholder */}
            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-red-600 text-2xl font-bold text-white">
              B
            </div>
            ...
            <a
              ...
              className="inline-block shrink-0 rounded-lg bg-red-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-red-700"
            >
              Ouvrir un compte →
            </a>
          </div>
