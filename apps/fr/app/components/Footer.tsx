    ...
    <footer className="bg-primary text-gray-400">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 pb-6">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6 mb-10">
          ...
          {/* Équipes */}
          <div>
            <h3 className="mb-3 text-xs font-bold text-white uppercase tracking-widest">
              Équipes
            </h3>
            <ul className="space-y-1.5 text-sm">
              {[
                ...
                { href: "/equipe/angleterre", label: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 Angleterre" },
              ].map((item) => (
                <li key={item.href}>
                  <Link href={item.href} className="hover:text-white transition-colors text-sm">
                    {item.label}
                  </Link>
                </li>
              ))}
              <li className="pt-1">
                <Link href="/equipes" className="text-gold hover:text-white font-medium text-sm transition-colors">
                  48 équipes →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li className="pt-1">
                <Link href="/comparateur-cotes" className="text-gold hover:text-white font-medium text-sm transition-colors">
                  Comparateur →
                </Link>
              </li>
            </ul>
