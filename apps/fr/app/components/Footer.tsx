    ...
    <footer className="bg-primary text-gray-400 dark:bg-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-12 pb-6">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-white/15 hover:text-white transition-all"
              >
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-10 border-t border-white/5 pt-8">
          {columns.map((col) => (
            <div key={col.title}>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 text-xs uppercase tracking-widest">
                {col.title}
              </h3>
