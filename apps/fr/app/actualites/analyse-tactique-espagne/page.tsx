      ...
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        <article className="prose prose-lg dark:prose-invert max-w-none">
          <div className="mb-4 flex items-center gap-3">
            <span className="inline-block rounded-full bg-red-100 px-3 py-1 text-xs font-medium text-red-800 dark:bg-red-900/30 dark:text-red-300">Analyse tactique</span>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link href="/actualites/analyse-tactique-france" className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 p-4 hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Le 4-3-3 de Deschamps décrypté</p>
            </Link>
