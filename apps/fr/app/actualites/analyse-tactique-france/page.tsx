      ...
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        <article className="prose prose-lg dark:prose-invert max-w-none">
          <div className="mb-4 flex items-center gap-3">
            ...
            <time className="text-sm text-gray-500 dark:text-gray-400" dateTime="2026-02-19">
              19 février 2026
            </time>
          </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Link href="/actualites/analyse-tactique-argentine" className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 p-4 hover:shadow-md transition">
              <h3 className="font-semibold text-gray-900 dark:text-white">🇦🇷 Analyse tactique Argentine</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Messi dernière CDM ? Système Scaloni décrypté</p>
            </Link>
            ...
            <Link href="/actualites/analyse-tactique-angleterre" className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 p-4 hover:shadow-md transition">
              <h3 className="font-semibold text-gray-900 dark:text-white">🏴󠁧󠁢󠁥󠁮󠁧󠁿 Analyse tactique Angleterre</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Potentiel immense vs déception historique</p>
            </Link>
            <Link href="/actualites/analyse-tactique-bresil" className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 p-4 hover:shadow-md transition">
              <h3 className="font-semibold text-gray-900 dark:text-white">🇧🇷 Analyse tactique Brésil</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Le Brésil de retour au sommet ?</p>
            </Link>
          </div>
        </div>
      </div>
