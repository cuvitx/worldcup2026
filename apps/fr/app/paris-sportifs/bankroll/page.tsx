...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.cdm2026.fr/paris-sportifs/bankroll" },
  openGraph: {
    title: "Gestion de bankroll — CDM 2026",
    description: "Budget, staking plan et Kelly criterion pour vos paris CDM 2026.",
    url: "https://www.cdm2026.fr/paris-sportifs/bankroll",
  },
};
...
export default function BankrollCdmPage() {
  ...
  return (
    <>
<Breadcrumb transparent items={[{ label: "Accueil", href: "/" }, { label: "Bankroll CDM" }]} />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-14">
        ...
        <div className="text-center">
          <Link href="/paris-sportifs/lexique" className="inline-flex items-center gap-2 bg-accent text-white rounded-xl py-3.5 px-8 font-semibold hover:opacity-90 transition-opacity">
