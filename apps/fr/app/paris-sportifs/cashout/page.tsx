...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.cdm2026.fr/paris-sportifs/cashout" },
  openGraph: {
    ...
    url: "https://www.cdm2026.fr/paris-sportifs/cashout",
  },
};
...
<Breadcrumb transparent items={[{ label: "Accueil", href: "/" }, { label: "Guide du Cashout" }]} />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-14">
        ...
        <div className="text-center">
          <Link href="/paris-sportifs/bankroll" className="inline-flex items-center gap-2 bg-accent text-white rounded-xl py-3.5 px-8 font-semibold hover:opacity-90 transition-opacity">
