...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.cdm2026.fr/paris-sportifs/value-bets" },
  openGraph: {
    ...
    url: "https://www.cdm2026.fr/paris-sportifs/value-bets",
  },
};
  ...
  return (
    <>
      ...
      <section className="max-w-3xl mx-auto px-4 py-10 text-center">
        ...
        >
          Comparer les cotes CDM 2026 sur PMU Sport{" "}
