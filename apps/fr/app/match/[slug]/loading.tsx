        ...
        <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 mb-8">
          <div className="flex items-center justify-center gap-8 mb-4">
            <div className="flex flex-col items-center gap-2">
              <div className="w-16 h-12 bg-gray-200-700 rounded-lg animate-pulse" />
              <div className="h-4 w-20 bg-gray-200-700 rounded-full animate-pulse" />
            </div>
            <div className="h-10 w-16 bg-gray-200-700 rounded-lg animate-pulse" />
            <div className="flex flex-col items-center gap-2">
              <div className="w-16 h-12 bg-gray-200-700 rounded-lg animate-pulse" />
              <div className="h-4 w-20 bg-gray-200-700 rounded-full animate-pulse" />
            </div>
          </div>
          <div className="h-4 w-48 mx-auto bg-gray-200-700 rounded-full animate-pulse mb-2" />
          <div className="h-3 w-32 mx-auto bg-gray-200-700 rounded-full animate-pulse" />
        </div>
