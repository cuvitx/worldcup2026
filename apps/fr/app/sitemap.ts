...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  entries.push(
    ...
    u("/paris-corners", { prio: 0.7 }),
    u("/paris-handicap", { prio: 0.7 }),
    u("/paris-live", { prio: 0.7 }),
    u("/paris-mi-temps", { prio: 0.7 }),
    u("/value-bets", { prio: 0.7 }),
    u("/dark-horses", { prio: 0.7 }),
    u("/guide-paris", { prio: 0.7 }),
    u("/ballon-or-cdm", { prio: 0.7 }),
    u("/esta-usa", { prio: 0.7 }),
    u("/visa-mexique", { prio: 0.7 }),
    u("/formalites-canada", { prio: 0.7 }),
    u("/decalage-horaire", { prio: 0.6 }),
    u("/assurance-voyage", { prio: 0.6 }),
    u("/calculateur-budget", { prio: 0.6 }),
    u("/alcool-stades", { prio: 0.6, freq: "monthly" }),
    u("/wifi-stades", { prio: 0.6, freq: "monthly" }),
  );
