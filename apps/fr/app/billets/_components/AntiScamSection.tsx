export function AntiScamSection() {
  ...
  return (
    <section id="anti-arnaques" className="bg-red-50 dark:bg-red-900/10 py-12 border-t border-red-100 dark:border-red-900/30">
          ...
          {tips.map((tip) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className={`text-sm font-semibold ${tip.type === "safe" ? "text-accent dark:text-accent" : "text-red-800 dark:text-red-400"}`}>
                  {tip.title}
                </h3>
              </div>
