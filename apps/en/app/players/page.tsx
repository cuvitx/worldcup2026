    ...
    <>
      <nav className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>/</li>
            <li className="text-gray-900 font-medium">Players</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="bg-primary text-white py-12">
        <div className="mx-auto max-w-7xl px-4">
          <h1 className="text-4xl font-extrabold">Key Players of the World Cup 2026</h1>
          <p className="mt-2 text-gray-300">
            {players.length} key players from all 48 teams. Forwards, midfielders, defenders and goalkeepers.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 space-y-8">
        ...
        <section className="rounded-lg bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-xl font-bold">Top International Scorers</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th className="pb-3 font-medium text-gray-500 text-right">Goals</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Caps</th>
                </tr>
              </thead>
                  ...
                  .map((player) => {
                    ...
                    return (
                      <tr key={player.id} className="hover:bg-gray-50">
                        <td className="py-3">
                          <Link href={`/player/${player.slug}`} className="font-medium hover:text-accent">
                            {player.name}
                          </Link>
                        </td>
                        <td className="py-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-primary">{player.goals} goals</p>
                        <p className="text-xs text-gray-400">{player.caps} caps</p>
                      </div>
                    </Link>
                  );
                })}
