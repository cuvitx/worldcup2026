...
const CURRENT_LANG = "en" as const;
...
const navLinks = [
  ...
  { href: "/group/a", label: "Groups" },
  { href: "/match/schedule", label: "Schedule" },
  { href: "/prediction/france", label: "Predictions" },
...
export function Header() {
  ...
  const searchData = useMemo(() => buildSearchIndex("en"), []);
    ...
    <header className="bg-primary text-white">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <SearchDialog lang="en" data={searchData} onNavigate={(href) => router.push(href)} />
