    ...
    <footer className="bg-primary text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="flex items-center justify-center gap-6 border-t border-white/10 pt-8">
          <a href="https://twitter.com/worldcup2026guide" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-gray-400 transition-colors hover:text-white">
          ...
          <a href="https://facebook.com/worldcup2026guide" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 transition-colors hover:text-white">
          ...
          <a href="https://instagram.com/worldcup2026guide" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 transition-colors hover:text-white">
