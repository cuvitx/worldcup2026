...
const CURRENT_LANG = "es" as const;
...
const navLinks = [
  ...
  { href: "/grupo/a", label: "Grupos" },
  { href: "/match/calendario", label: "Calendario" },
  { href: "/pronostico/mexico", label: "Pronosticos" },
...
export function Header() {
  ...
  const searchData = useMemo(() => buildSearchIndex("es"), []);
    ...
    <header className="bg-primary text-white">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <SearchDialog lang="es" data={searchData} onNavigate={(href) => router.push(href)} />
