...
export const metadata: Metadata = {
  title: "Partidos de hoy - Copa del Mundo 2026",
  description:
    "Consulta los partidos de la Copa del Mundo 2026 que se juegan hoy. Horarios, equipos, estadios, grupos y enlaces a los pronosticos de cada partido.",
  alternates: getStaticAlternates("matchToday", "es"),
};
    ...
    <>
      <nav className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>/</li>
            <li className="text-gray-900 font-medium">Partidos de hoy</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="bg-primary text-white py-12">
        <div className="mx-auto max-w-7xl px-4">
          <h1 className="text-4xl font-extrabold">Partidos de hoy</h1>
          <p className="mt-2 text-gray-300">
            {todaysMatches.length > 0
              ? `${todaysMatches.length} partido${todaysMatches.length > 1 ? "s" : ""} hoy`
        ...
        {todaysMatches.length > 0 ? (
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-8 text-center">
            ...
            {nextMatch && (() => {
              ...
              return (
                <div className="mt-4">
                  <p className="text-sm text-gray-500 mb-3">Proximo partido:</p>
                  <Link
                  ...
                  >
                    ...
                    <p className="font-semibold text-gray-900">
                      ...
                      {away?.name ?? "Por determinar"} {away?.flag}
                    </p>
                    {stadium && (
