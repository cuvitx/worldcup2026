...
export const metadata: Metadata = {
  title: "Cuadro final Mundial 2026 | Bracket y fase eliminatoria completa",
  description:
    "Cuadro final del Mundial 2026: bracket completo de 32avos, octavos, cuartos, semifinales y final. Pronosticos basados en rankings ELO para cada ronda.",
  alternates: getStaticAlternates("bracket", "es"),
  openGraph: {
    title: "Cuadro final - Mundial 2026",
    description:
      "Visualiza el bracket completo de la fase eliminatoria del Mundial 2026 en EE.UU., Canada y Mexico.",
  },
};
...
const r32Bracket: Array<{
  ...
  { matchId: "m75", homeLabel: "1E", awayLabel: "3o ABCDF", homeTeamId: groupStandings.E?.first ?? null, awayTeamId: null },
  ...
  { matchId: "m78", homeLabel: "1I", awayLabel: "3o CDFGH", homeTeamId: groupStandings.I?.first ?? null, awayTeamId: null },
  { matchId: "m79", homeLabel: "1A", awayLabel: "3o CEFHI", homeTeamId: groupStandings.A?.first ?? null, awayTeamId: null },
  { matchId: "m80", homeLabel: "1L", awayLabel: "3o EHIJK", homeTeamId: groupStandings.L?.first ?? null, awayTeamId: null },
  { matchId: "m81", homeLabel: "1G", awayLabel: "3o AEHIJ", homeTeamId: groupStandings.G?.first ?? null, awayTeamId: null },
  { matchId: "m82", homeLabel: "1D", awayLabel: "3o BEFIJ", homeTeamId: groupStandings.D?.first ?? null, awayTeamId: null },
  ...
  { matchId: "m85", homeLabel: "1B", awayLabel: "3o EFGIJ", homeTeamId: groupStandings.B?.first ?? null, awayTeamId: null },
  ...
  if (!team) {
    return (
      <div className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 italic">
        ...
        <span>{label ?? "Por determinar"}</span>
      </div>
    );
  }
  return (
    ...
    <>
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>/</li>
            <li className="text-gray-900 font-medium">Cuadro final</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="bg-primary text-white py-12">
        <div className="mx-auto max-w-7xl px-4">
          <h1 className="text-4xl font-extrabold">Cuadro final Mundial 2026</h1>
          <p className="mt-2 text-gray-300 max-w-2xl">
            Bracket completo de la fase eliminatoria: 32avos de final, octavos de final,
            cuartos de final, semifinales y la gran final. Pronosticos basados en ratings ELO.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 space-y-12">
        ...
        {champion && teamsById[champion] && (
          <section className="rounded-xl border-2 border-yellow-400 bg-gradient-to-r from-yellow-50 to-amber-50 p-6 text-center">
            <p className="text-sm font-medium text-amber-700 uppercase tracking-wide mb-2">Campeon predicho</p>
            <Link href={`/equipo/${teamsById[champion]!.slug}`} className="inline-flex items-center gap-3 hover:opacity-80">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Basado en rankings ELO y pronosticos de la fase de grupos
            </p>
          </section>
        )}
        ...
        <section className="rounded-lg bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-xl font-bold">Probabilidades por ronda</h2>
          <p className="text-sm text-gray-500 mb-4">
            Probabilidades de cada equipo de alcanzar cada ronda, basadas en rankings ELO.
          </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th className="pb-3 font-medium text-gray-500 text-right">Fase de grupos</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Octavos</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Cuartos</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Semis</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Final</th>
                  <th className="pb-3 font-medium text-gray-500 text-right">Campeon</th>
                </tr>
              </thead>
        ...
        <section className="prose max-w-none">
          <h2>Como funciona el cuadro final del Mundial 2026?</h2>
          <p>
            El Mundial 2026 cuenta con 48 equipos repartidos en 12 grupos de 4. Tras la fase de grupos,
            los dos primeros de cada grupo (24 equipos) y los 8 mejores terceros clasifican para la fase
            eliminatoria, un total de 32 equipos.
          </p>
          <p>
            El cuadro final comienza con los 32avos de final (16 partidos), seguidos de los octavos de final
            (8 partidos), cuartos de final (4 partidos), semifinales (2 partidos) y la gran final en el
            MetLife Stadium de Nueva York el 19 de julio de 2026.
          </p>
          <h3>Pronosticos del bracket</h3>
          <p>
            Los pronosticos mostrados en esta pagina se basan en los rankings ELO de los equipos. El equipo
            con mayor rating ELO se predice como ganador en cada enfrentamiento. Estos pronosticos se
            actualizaran a medida que avance el torneo con los resultados reales.
          </p>
        </section>
      </div>
    </>
