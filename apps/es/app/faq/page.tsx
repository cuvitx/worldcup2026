...
export function generateMetadata(): Metadata {
  return {
    title: "Preguntas frecuentes - Copa del Mundo 2026",
    description:
      "Encuentra respuestas a todas tus preguntas sobre la Copa del Mundo FIFA 2026: formato del torneo, equipos clasificados, apuestas deportivas, pronosticos y mas.",
    alternates: getStaticAlternates("faq", "es"),
  };
}
      ...
      <section className="bg-primary text-white py-12">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <p className="mt-2 text-gray-300">
            Todo lo que necesitas saber sobre la Copa del Mundo FIFA 2026
          </p>
        </div>
      </section>
