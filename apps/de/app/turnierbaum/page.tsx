...
export default function BracketPage() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Selon le bracket basé sur les classements ELO et les probabilités statistiques, la France est le grand favori pour remporter la WM 2026. Avec un effectif exceptionnel mené par Kylian Mbappé, une solidité défensive et une expérience des grandes compétitions (champion 2018, vice-champion 2022), les Bleus ont les meilleures chances. Le Brésil, l'Angleterre, l'Argentine et l'Espagne sont également des prétendants sérieux au titre."
    },
    {
      ...
      <section className="hero-animated text-white py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-gray-300 max-w-2xl">
            ...
            quarts de finale, demi-finales et finale. Prognoses bases sur les classements ELO.
          </p>
        </div>
      </section>
