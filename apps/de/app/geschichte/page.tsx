...
const editions: CdmEdition[] = [
  { year: 1930, host: "Uruguay", hostFlag: "🇺🇾", winner: "Uruguay", winnerFlag: "🇺🇾", runnerUp: "Argentine", runnerUpFlag: "🇦🇷", score: "4–2", topScorer: "Guillermo Stábile", topScorerGoals: 8, teams: 13, totalGoals: 70, highlight: "La naissance du Mondial", highlightDetail: "La première WM se tient en Uruguay pour le centenaire du pays. 13 Mannschafts seulement participent, aucun Européen majeur ne fait le déplacement par voie maritime.", color: "from-amber-500 to-amber-700" },
  ...
  { year: 1938, host: "France", hostFlag: "🇫🇷", winner: "Italie", winnerFlag: "🇮🇹", runnerUp: "Hongrie", runnerUpFlag: "🇭🇺", score: "4–2", topScorer: "Leônidas", topScorerGoals: 7, teams: 15, totalGoals: 84, highlight: "Double champion !", highlightDetail: "L'Italie devient la première Mannschaft à remporter deux Coupes du Monde consécutives. Le Brésilien Leônidas, surnommé 'le Diamant Noir', régale le public parisien.", color: "from-blue-600 to-blue-800" },
  ...
  { year: 1970, host: "Mexique", hostFlag: "🇲🇽", winner: "Brésil", winnerFlag: "🇧🇷", runnerUp: "Italie", runnerUpFlag: "🇮🇹", score: "4–1", topScorer: "Gerd Müller", topScorerGoals: 10, teams: 16, totalGoals: 95, highlight: "La plus belle Mannschaft de l'histoire", highlightDetail: "Pelé, Jairzinho, Tostão, Rivelino : le Brésil 1970 est souvent cité comme la plus belle Mannschaft de tous les temps. Sieg 4-1 en finale et conservation définitive du trophée Jules Rimet.", color: "from-yellow-400 to-accent" },
  ...
  { year: 2014, host: "Brésil", hostFlag: "🇧🇷", winner: "Allemagne", winnerFlag: "🇩🇪", runnerUp: "Argentine", runnerUpFlag: "🇦🇷", score: "1–0 a.p.", topScorer: "James Rodríguez", topScorerGoals: 6, teams: 32, totalGoals: 171, highlight: "Le 7–1 : le Mineirazo", highlightDetail: "Brésil 1–7 Allemagne en demi-finale : la plus grande déroute de l'histoire du football brésilien. Neymar absent blessé, le Brésil s'effondre. L'Allemagne gagne son 4e titre. James Rodríguez, révélation des Turniers.", color: "from-yellow-400 to-red-500" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:grid lg:grid-cols-[1fr_220px] lg:gap-8">
        ...
        <div className="text-center mb-12 max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            ...
            Découvrez l&apos;histoire complète des Turniers le plus regardé de la planète.
          </p>
        </div>
        ...
        <div className="mt-12 grid sm:grid-cols-3 gap-4">
          {[
            { href: "/palmares", icon: "", label: "Erfolge complet", desc: "Tous les vainqueurs de 1930 à 2022" },
            { href: "/statistiques", icon: "", label: "Statistiques", desc: "Records, buteurs, buts par édition" },
            { href: "/mannschaft", icon: "", label: "Les 48 Mannschafts 2026", desc: "Groupes, effectifs et pronostics" },
      ...
      <RelatedLinks
        links={[
          ...
          },
          {
            ...
            description: "Découvrez les 48 Mannschafts qualifiées pour la prochaine WM.",
            icon: ""
          }
        ]}
      />
