  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center min-h-[80vh] px-4 py-16 text-center bg-gray-50">
      ...
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-accent/10 border border-accent/20 text-accent text-sm font-semibold mb-6">
         Gelbe Karte — Technischer Fehler
      </div>

      {/* Titel */}
      <h1 className="text-3xl sm:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
        Gelbe Karte!{" "}
        <span className="text-primary">Ein technischer Fehler</span> ist aufgetreten
      </h1>

      {/* Untertitel */}
      <p className="text-gray-500 text-lg max-w-md mb-3">
        Der Schiedsrichter hat einen technischen Fehler gepfiffen. Keine Sorge, das Spiel kann weitergehen.
      </p>
      {error.digest && (
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        >
          <svg className="w-4 h-4 inline-block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg> Erneut versuchen
        </button>
        <Link
          href="/"
