...
<section className="hero-animated text-center py-16 px-4">
        ...
        <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
          Profil disciplinaire, stats et cotes comparées pour parier sur un carton jaune de {player.name} ({team?.name}) à la WM 2026.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className={`rounded-xl p-6 mb-8 ${stats.isRough ? "bg-gradient-to-r from-yellow-50 to-red-50 border border-yellow-200" : "bg-gradient-to-r from-green-50 to-blue-50 border border-green-200"}`}>
          <h3 className="text-xl font-bold text-primary mb-2">
            Profil : {stats.isRough ? " Spieler rugueux" : " Spieler fair-play"}
          </h3>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-primary">Historique cartons en WM</h2>
        </div>
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          {stats.wcCards > 0 ? (
            <p className="text-gray-700">
              {player.name} a reçu <span className="font-bold text-yellow-500">{stats.wcCards} carton{stats.wcCards > 1 ? "s" : ""} jaune{stats.wcCards > 1 ? "s" : ""}</span> lors de ses participations précédentes en WM.
            ...
            <p className="text-gray-700">
              {player.name} n&apos;a pas encore reçu de carton jaune en WM ou participe pour la première fois au tournoi en 2026.
            </p>
          )}
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-600">Les matchs à élimination directe et les derbys génèrent plus de tension. Gruppenphase = moins de cartons en moyenne que les 8es ou quarts de finale.</p>
          </div>
          <div className="bg-white rounded-xl border border-gray-200 p-5">
