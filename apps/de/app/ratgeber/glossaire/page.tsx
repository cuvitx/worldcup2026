...
const glossary: Term[] = [
  ...
  { name: "Arjel / ANJ", definition: "Autorité Nationale des Jeux, régulateur français des paris en ligne. Garantit la légalité et la protection des joueurs.", example: "PokerStars Sports, Betsson et PMU Sport sont agréés par l'ANJ pour opérer en France." },
  ...
  { name: "Bookmaker", definition: "Opérateur de paris sportifs qui propose des cotes et accepte les mises des parieurs.", example: "PokerStars Sports, Betsson, PMU Sport sont les principaux bookmakers français pour la CDM 2026." },
  ...
  { name: "Bonus de bienvenue", definition: "Offre promotionnelle pour les nouveaux inscrits chez un bookmaker.", example: "PokerStars Sports offre 100€ de freebets à l'inscription pour parier sur la CDM 2026." },
  ...
  { name: "Enhanced Odds", definition: "Cotes améliorées temporairement par un bookmaker comme promotion.", example: "PMU Sport booste la cote de l'Argentine vainqueur de la CDM de 4.50 à 6.00." },
