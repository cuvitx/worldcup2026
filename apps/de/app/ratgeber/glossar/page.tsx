...
const glossary: Term[] = [
  ...
  { name: "Futures", definition: "Pari à long terme sur un résultat futur (vainqueur des Turniers, Torschützenkönig...).", example: "Parier dès maintenant que le Brésil remportera la WM 2026." },
