...
const glossary: Term[] = [
  ...
  { name: "Ante-post", definition: "Pari placé bien avant un événement, souvent avant le début du tournoi.", example: "Wetten auf le vainqueur de la CDM 2026 dès aujourd'hui, avant le coup d'envoi en juin." },
  ...
  { name: "Futures", definition: "Pari à long terme sur un résultat futur (vainqueur du tournoi, meilleur buteur...).", example: "Parier dès maintenant que le Brésil remportera la WM 2026." },
  ...
  { name: "In-Play (Live Betting)", definition: "Paris placés pendant le déroulement du match, avec des cotes qui évoluent en temps réel.", example: "Wetten auf le prochain buteur à la 60e minute de Espagne vs Turquie." },
  ...
  { name: "Stake", definition: "Terme anglais pour la mise. Le montant engagé sur un pari.", example: "Stake de 50€ sur le vainqueur de la WM 2026." },
  ...
  { name: "Wincast", definition: "Pari combinant un buteur et la victoire de son Mannschaft.", example: "Mbappé buteur + victoire de la France contre la Colombie." },
  ...
  { name: "Acca Insurance", definition: "Promotion remboursant un combiné si une seule sélection est perdante.", example: "Combiner 5 matchs de groupe : si 4 sur 5 sont bons, PokerStars Sports rembourse la mise." },
  ...
  { name: "Dead Heat", definition: "Règle appliquée quand deux Spielers ou plus finissent ex-aequo sur un marché.", example: "Deux Spielers finissent co-meilleurs buteurs de la CDM 2026 : la mise est divisée." },
  ...
  { name: "Outsider", definition: "Mannschaft ou Spieler donné avec peu de chances de gagner.", example: "Haïti est l'outsider ultime du Groupe C avec le Brésil et le Maroc." },
