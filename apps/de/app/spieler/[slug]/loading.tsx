    ...
    <div className="flex flex-1 flex-col min-h-[70vh] bg-gray-50">
      <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6 mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="h-4 w-32 bg-gray-200 rounded-full mb-2 animate-pulse" />
        ...
        <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-6">
          <div className="h-5 w-24 bg-gray-200 rounded-full mb-4 animate-pulse" />
          <div className="space-y-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="h-4 bg-gray-200 rounded-full animate-pulse" style={{ width: `${85 - i * 15}%` }} />
            ))}
          </div>
        </div>
      </div>
