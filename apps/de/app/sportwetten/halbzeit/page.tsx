...
const resultatsHtFt = [
  { combo: "1/1", description: "Mannschaft A mène à la MT et gagne", frequence: "~28%", coteType: "1.80 – 2.50" },
  { combo: "X/1", description: "Nul à la MT, Mannschaft A gagne", frequence: "~14%", coteType: "3.50 – 5.00" },
  { combo: "2/1", description: "Mannschaft B mène à la MT, A gagne (remontada)", frequence: "~3%", coteType: "12.00 – 25.00" },
  { combo: "1/X", description: "Mannschaft A mène à la MT, nul final", frequence: "~6%", coteType: "6.00 – 10.00" },
  { combo: "X/X", description: "Nul à la MT et nul final", frequence: "~12%", coteType: "4.00 – 5.50" },
  { combo: "2/X", description: "Mannschaft B mène à la MT, nul final", frequence: "~5%", coteType: "8.00 – 14.00" },
  { combo: "1/2", description: "Mannschaft A mène à la MT, B gagne (remontada)", frequence: "~3%", coteType: "12.00 – 25.00" },
  { combo: "X/2", description: "Nul à la MT, Mannschaft B gagne", frequence: "~13%", coteType: "3.80 – 5.50" },
  { combo: "2/2", description: "Mannschaft B mène à la MT et gagne", frequence: "~16%", coteType: "2.50 – 4.00" },
];

const statsCDM = [
  { stat: "Matchs où le score change en 2e MT", valeur: "~42%", detail: "Presque 1 match sur 2 voit le score évoluer après la pause" },
  { stat: "Matchs 0-0 à la mi-temps", valeur: "~38%", detail: "Les Mannschafts se jaugent en 1ère MT de CDM, surtout en phase de groupes" },
  { stat: "Remontadas (mené MT → gagne)", valeur: "~6%", detail: "Rare mais très lucratif en termes de cotes" },
  { stat: "Tore geschossen en 2e MT", valeur: "~56%", detail: "La majorité des buts tombent après la pause (fatigue, tactique, pression)" },
...
const strategies = [
  ...
  },
  {
    ...
    description: "Les Mannschafts qui ouvrent le score tôt (avant la 30e) gagnent dans 85% des cas en CDM. Identifiez les favoris qui marquent vite : données à croiser avec les statistiques de temps du 1er but.",
    coteType: "1.80 – 2.50",
    risque: "Faible",
  },
  {
  ...
  },
  {
    ...
    description: "Les nuls sont fréquents en J1 (les Mannschafts ne veulent pas perdre) et J3 (matchs sans enjeu ou résultats arrangés). Cote ~4.50 pour un bon rendement.",
    coteType: "4.00 – 5.50",
    risque: "Moyen",
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Non, seulement ~6% des matchs voient l'Mannschaft menée à la mi-temps l'emporter. C'est rare mais mémorable (Allemagne-Suède 2018 : 0-1 MT → 2-1 FT). Les cotes de 12-25 reflètent cette faible probabilité.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12 space-y-14">
        ...
        <section>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 prose max-w-none">
            ...
            <p>
              <strong>Notation :</strong> 1 = victoire Mannschaft à domicile / favori, X = nul, 2 = victoire
