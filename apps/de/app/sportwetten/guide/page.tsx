...
export const metadata: Metadata = {
  ...
  description:
    "Guide complet pour parier sur la WM 2026. Types de paris (1X2, Over/Under, BTTS, handicap), lexique, bankroll management et stratégies gagnantes.",
  openGraph: {
      ...
      <section className="hero-animated text-white py-14 sm:py-20">
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
            Guide complet pour débutants : types de paris, lexique, stratégies et conseils pour parier intelligemment sur la WM 2026.
          </p>
        </div>
      </section>
