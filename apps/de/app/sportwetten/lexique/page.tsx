...
const glossary: Term[] = [
  ...
  },
  {
    ...
    example:
      "Vérifier les cotes de PMU Sport pour France – Brésil en demi-finale avant de placer votre mise.",
  },
  {
