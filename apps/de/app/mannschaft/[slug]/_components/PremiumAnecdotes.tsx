        ...
        <div className="relative pl-8 md:pl-0 md:max-w-3xl md:mx-auto">
          ...
          {anecdotes.map((anecdote, i) => {
            ...
            return (
              ...
              >
                {/* Dot on timeline */}
                <div className="absolute left-1.5 md:left-1/2 md:-translate-x-1/2 top-1 w-3 h-3 rounded-full bg-accent border-2 border-white z-10" />
