      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <span></span> Top 10 der Favoriten WM 2026
          </h2>
          <p className="text-sm text-gray-600 mt-1">Rangliste nach Siegwahrscheinlichkeit (ELO-Modell + Buchmacher-Quoten)</p>
        </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 px-5 py-4">
                  ...
                  <div className="shrink-0 text-right hidden sm:block">
                    ...
                    <p className="text-xs text-gray-600">Titelchance</p>
                  </div>
                  <div className="shrink-0 text-right">
                    ...
                    <p className="text-xs text-gray-600">
                      {fav ? "Durchschn. Marktquote" : "ca. Quote"}
                    </p>
                  </div>
                </div>

                {/* Real bookmaker odds strip (Betano) */}
                {fav && (
                ...
                <div className="flex sm:hidden items-center gap-4 px-5 pb-3">
                  ...
                  <span className="text-sm text-gray-600">Chance den Titel zu gewinnen</span>
                </div>
                ...
                {args && (
                  <div className="grid sm:grid-cols-2 gap-0 border-t border-gray-100">
                    <div className="p-4 bg-accent/10">
                      <p className="text-xs font-bold text-accent mb-2">Stärken</p>
                    ...
                    <div className="p-4 bg-red-50/50 border-t sm:border-t-0 sm:border-l border-gray-100">
                      <p className="text-xs font-bold text-red-600 mb-2">Schwächen</p>
                      <ul className="space-y-1">
