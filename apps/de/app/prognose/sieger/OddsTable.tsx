    ...
    <section id="cotes" className="bg-white py-12 border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Quoten Sieger WM 2026 — Betano
        </h2>
        <p className="text-sm text-gray-600 mb-1">
          Dezimalquoten Betano. Aktualisiert: <span className="font-semibold text-gray-700">Juni 2026</span>.
        </p>
        <p className="text-xs text-gray-600 mb-6">
          ↑ Aufwärtstrend vs. Eröffnungsquoten (Dez. 2025) · ↓ Abwärtstrend · → Stabil
        </p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 text-xs uppercase text-gray-500text-gray-700">
                <th className="text-left px-3 sm:px-4 py-3 font-bold">Team</th>
                <th className="text-center px-2 sm:px-4 py-3 font-bold whitespace-nowrap text-primary">Quote Betano</th>
                <th className="text-center px-2 sm:px-4 py-3 font-bold text-accent whitespace-nowrap">Durchschn.</th>
                <th className="text-center px-2 sm:px-4 py-3 font-bold text-primary whitespace-nowrap">Wahrsch.</th>
        ...
        <div className="mt-4 flex flex-wrap gap-4 items-start justify-between">
          <div className="flex flex-wrap gap-3 text-xs text-gray-600">
            <span className="text-accent font-semibold">↑ Aufwärtstrend</span>
            <span className="text-red-500 font-semibold">↓ Abwärtstrend</span>
            <span>→ Stabil</span>
          </div>
          <p className="text-xs text-gray-600 max-w-xs text-right">
            Quelle: Betano. Dezimalquoten. Verantwortungsvolles Spielen — 18+.
          </p>
        </div>
        ...
        <div className="mt-6">
          ...
          >
            <div>
              <p className="font-bold text-gray-900">Betano</p>
              <p className="text-sm text-primary font-semibold">Willkommensbonus</p>
              <p className="text-xs text-gray-600">als Freebets ohne Bedingungen</p>
            </div>
