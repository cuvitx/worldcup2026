      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-6">
          <Card hover padding="md" className="text-center">
            ...
            <p className="text-sm text-gray-600 font-medium">Gastgeber als Sieger</p>
            <p className="text-xs text-gray-500 mt-1">bei {totalEditions} Ausgaben seit 1930</p>
          </Card>
          <Card hover padding="md" className="text-center">
            <p className="text-4xl font-extrabold text-accent mb-1">{homeWinPct}%</p>
            <p className="text-sm text-gray-600 font-medium">Siegquote zu Hause</p>
            <p className="text-xs text-gray-500 mt-1">Beachtlicher Heimvorteil</p>
          </Card>
          <div className="rounded-xl border border-accent/30 bg-accent/10 p-5 text-center">
            ...
            <p className="text-sm text-accent font-medium">Gastgeberländer 2026</p>
            <p className="text-xs text-accent/70 mt-1">USA, Kanada, Mexiko — dreifacher Heimvorteil</p>
          </div>
        </div>
        ...
        <details className="group">
          <summary className="cursor-pointer flex items-center gap-2 text-sm font-semibold text-primary hover:underline list-none mb-4">
            ...
            Vollständige Geschichte anzeigen ({totalEditions} Ausgaben)
          </summary>
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-gray-50 text-xs uppercase text-gray-500text-gray-700">
                  ...
                  <th className="text-left px-3 py-2">Gastgeber</th>
                  <th className="text-left px-3 py-2">Sieger</th>
                  <th className="text-left px-3 py-2 hidden sm:table-cell">Anmerkung</th>
        ...
        <div className="mt-6 rounded-xl border border-primary/20 bg-primary/5 p-5">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            Zum ersten Mal in der Geschichte <strong>teilen sich 3 Länder die Organisation</strong>. Der Heimvorteil ist daher verdünnt, aber vorhanden. Historisch profitiert das Gastgeberland von <strong>+6 bis +8 ELO-Punkten</strong> dank der Unterstützung des Publikums und der Kenntnis der lokalen Bedingungen.
          </p>
          <div className="grid sm:grid-cols-3 gap-3">
            {[
              { flag: "🇺🇸", name: "USA", note: "Spielen vor 80.000 Heimfans. Realistisches Ziel: Viertelfinale.", chance: "4.2%" },
              { flag: "🇨🇦", name: "Kanada", note: "Alphonso Davies in Topform. Erste WM — die Begeisterung kann Wunder wirken.", chance: "1.8%" },
              { flag: "🇲🇽", name: "Mexiko", note: "Das Azteca auf 2.240m Höhe — erheblicher physischer Vorteil in der Gruppenphase.", chance: "2.1%" },
            ].map((host) => (
