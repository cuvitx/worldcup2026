...
> = {
  ...
  CONMEBOL: {
    ...
    label: "CONMEBOL (Südamerika)",
  },
  CONCACAF: {
    bg: "bg-accent",
    border: "border-accent/60",
    label: "CONCACAF (Nordamerika)",
  },
  CAF: {
    bg: "bg-primary/70",
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Titelchancen nach Konföderation"
          subtitle="Balken proportional zu den Wahrscheinlichkeiten — farblich nach Konföderation"
        />

        {/* Legende Konföderationen */}
        ...
        <div className="mt-4 text-xs text-gray-600">
          * Balkenbreite proportional zur Wahrscheinlichkeit, den Titel zu gewinnen
          (ELO-Modell). Die Quoten sind indikativ.
        </div>
      </div>
    </section>
  );
