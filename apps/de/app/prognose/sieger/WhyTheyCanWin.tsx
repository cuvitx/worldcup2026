  ...
  return (
    <section id="analyse-top5" className="bg-white py-12 border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading title="Warum sie gewinnen können — Analyse Top 5" subtitle="Tiefgehende Analyse der 5 Teams mit der höchsten Wahrscheinlichkeit, den Pokal zu holen" />
                ...
                <div className="flex items-center gap-4 px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-0.5 flex-wrap">
                      <span className="text-sm text-primary font-bold">{winPct}% Titelchance</span>
                      <span className="text-sm text-accent font-bold">Quote {analysis.betOdds}</span>
