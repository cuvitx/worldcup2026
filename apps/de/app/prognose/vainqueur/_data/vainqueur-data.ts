...
export const faqItems = [
  {
    question: "Qui est favori pour gagner la WM 2026 ?",
    answer:
  ...
  {
    question: "Quelle équipe a le meilleur bilan en WM ?",
    answer:
  ...
  {
    question: "L'avantage à domicile joue-t-il un rôle en WM ?",
    answer:
...
> = {
  ...
  "pays-bas": {
    ...
    cons: [
      ...
      "Ergebnisse CDM décevants depuis 2014",
    ],
  },
  belgique: {
    pros: [
...
> = {
  ...
  bresil: {
    ...
    keyPlayerDesc:
      "Deux fois finaliste de Ligue des Champions, vainqueur de la WM des clubs. L'ailier du Real Madrid peut gagner un match à lui seul.",
    tacticalEdge:
