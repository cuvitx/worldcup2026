...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Top 15 favoris, cotes Betano et dark horses pour le Soulier d'Or 2026.",
...
const darkHorses = [
  ...
  { name: "Lautaro Martínez", team: "🇦🇷 Argentine", cote: 20.0, reason: "Torschützenkönig de la Copa América 2024, soutenu par le système argentin." },
];
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-700 mb-6">
          Ces Spielers ne sont pas les favoris des bookmakers, mais leur profil et leur situation pourraient créer la surprise. Des cotes élevées pour une value potentielle intéressante.
        </p>
      ...
      {/* FAQ */}
      <FAQSection title="Häufig gestellte Fragen — Torschützenkönig CDM 2026" items={faqItems} />
