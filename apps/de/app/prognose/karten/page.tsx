...
export const metadata: Metadata = {
  ...
  description:
    "Guide des paris cartons pour la CDM 2026. Stats par Mannschaft, arbitres FIFA désignés, Spielers les plus avertis et meilleures cotes.",
  alternates: { canonical: "https://www.wm2026guide.de/prognose/karten" },
  openGraph: {
    title: "Paris Cartons CDM 2026",
    description: "Stats cartons par Mannschaft, arbitres FIFA et Spielers les plus avertis pour la CDM 2026.",
...
const warningPlayers = [
  ...
  { name: "Nicolás Otamendi", team: "🇦🇷", totalCards: 8, note: "Verteidiger engagé, souvent averti." },
  { name: "Casemiro", team: "🇧🇷", totalCards: 6, note: "Mittelfeldspieler récupérateur, spécialiste des fautes tactiques." },
...
const faqItems = [
  { question: "Quels types de paris cartons existe-t-il ?", answer: "Les bookmakers proposent plusieurs marchés : nombre total de cartons jaunes (Over/Under), première Mannschaft à recevoir un carton, Spieler à recevoir un carton, carton rouge dans le match (Oui/Non). Les cotes varient de 1.5 à 15.0 selon le marché." },
  { question: "Quelles Mannschafts reçoivent le plus de cartons en CDM ?", answer: "Les Mannschafts sud-américaines et africaines ont historiquement les taux de cartons les plus élevés. L'Argentine, l'Uruguay et le Cameroun sont régulièrement parmi les Mannschafts les plus sanctionnées, avec en moyenne plus de 2 cartons jaunes par match." },
  ...
  { question: "Les cartons sont-ils plus fréquents en phase finale ?", answer: "Oui, les matchs à élimination directe produisent en moyenne 15-20% de cartons en plus que les matchs de poules. L'enjeu accru pousse les Spielers à des fautes plus dures et les tensions sont plus vives." },
];
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-primary">Stats cartons par Mannschaft</h2>
        </div>
        <p className="text-gray-700 mb-6">
          Le style de jeu et la culture footballistique influencent fortement le nombre de cartons. Les Mannschafts physiques et les confrontations sud-américaines produisent systématiquement plus de sanctions. Voici les stats des Mannschafts les plus sanctionnées sur les 10 derniers matchs officiels.
        </p>
      ...
      <section className="max-w-3xl mx-auto px-4 py-10 text-center">
        <a href={pmuTrackingUrl("prono-special")} target="_blank" rel="noopener noreferrer sponsored nofollow" className="inline-block bg-accent text-white rounded-xl py-3.5 px-8 font-semibold hover:opacity-90 transition-opacity">
          Willkommensbonus — Wetten auf les cartons CDM 2026 sur Betano <ArrowRight className="inline w-4 h-4 ml-1" />
        </a>
        <p className="text-xs text-gray-400 mt-3">18+ | Es gelten die AGB</p>
      </section>

      <FAQSection title="Häufig gestellte Fragen — Cartons CDM 2026" items={faqItems} />
