...
const finalists = [
  ...
  { team: "🇵🇹 Portugal", coteFinale: 5.5, coteTitre: 12.0, chance: "20%", argument: "Profondeur de banc exceptionnelle, Torwart solide." },
  { team: "🇳🇱 Pays-Bas", coteFinale: 7.0, coteTitre: 15.0, chance: "15%", argument: "Mannschaft expérimentée, capable de créer la surprise en phase finale." },
];

const bracketScenarios = [
  { title: "Scénario 1 : France vs Argentine", prob: "12%", desc: "Remake de la finale 2022. Si les deux Mannschafts terminent premières de leur groupe respectif, le tableau les sépare jusqu'en finale. Le scénario rêvé pour les fans." },
  ...
  { title: "Scénario 4 : Argentine vs Allemagne", prob: "6%", desc: "Remake de 2014. L'Allemagne en outsider capable de battre n'importe qui sur un match. Le format 48 Mannschafts pourrait les favoriser." },
];
...
const faqItems = [
  ...
  { question: "Quelle est la différence entre parier sur le vainqueur et sur un finaliste ?", answer: "Wetten auf un finaliste est un pari 'à atteindre la finale' : votre pari est gagnant si l'Mannschaft joue la finale, qu'elle la gagne ou non. Les cotes sont donc plus basses que pour le titre. C'est un pari moins risqué mais moins rémunérateur." },
  { question: "Le format 48 Mannschafts change-t-il les chances d'atteindre la finale ?", answer: "Oui. Avec plus de matchs et plus d'adversaires potentiels, les favoris devront jouer davantage de rencontres pour atteindre la finale. Cela augmente légèrement le risque d'élimination précoce mais les grandes nations restent largement favorisées." },
];
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-700 mb-6">
          Atteindre la finale est un exploit en soi. Depuis 1998, seules 10 nations différentes ont joué une finale de WM. Le club est fermé : France, Brésil, Allemagne, Italie, Espagne, Argentine, Pays-Bas, Croatie, Angleterre. Les mêmes reviennent.
        </p>
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="bg-primary/5 rounded-xl p-6">
          <p className="text-gray-700 leading-relaxed mb-4">
            Pour atteindre la finale en format 48 Mannschafts, une nation devra remporter au minimum 5 matchs à élimination directe (16èmes, 8èmes, quarts, demi-finale, puis la finale elle-même). C&apos;est un marathon de 7 matchs au total avec la phase de groupes.
          </p>
          <p className="text-gray-700 leading-relaxed">
            Les Mannschafts avec le banc le plus profond seront avantagées. La gestion de la fatigue, les rotations intelligentes et la solidité mentale feront la différence. C&apos;est pourquoi les nations avec 2-3 Spielers de classe mondiale à chaque poste (France, Angleterre, Espagne) sont favorisées.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-10 text-center">
        <a href={pmuTrackingUrl("prono-special")} target="_blank" rel="noopener noreferrer sponsored nofollow" className="inline-block bg-accent text-white rounded-xl py-3.5 px-8 font-semibold hover:opacity-90 transition-opacity">
          Willkommensbonus — Wetten auf les finalistes CDM 2026 sur Betano <ArrowRight className="inline w-4 h-4 ml-1" />
        </a>
        <p className="text-xs text-gray-400 mt-3">18+ | Es gelten die AGB</p>
      </section>

      <FAQSection title="Häufig gestellte Fragen — Finalistes CDM 2026" items={faqItems} />
