...
export const metadata: Metadata = {
  ...
  description:
    "Version imprimable du spielplan complet de la WM 2026 : les 104 matchs avec dates, horaires, stades et équipes. Format PDF.",
  ...
  return (
    ...
    <div className="print-calendar mx-auto max-w-4xl px-4 sm:px-6 py-10 sm:py-12">
      ...
      {sortedDates.map((date) => {
        ...
        const formatted = new Date(date + "T12:00:00Z").toLocaleDateString("de-DE", {
          weekday: "long",
          day: "numeric",
          month: "long",
          year: "numeric",
