...
export const metadata: Metadata = {
  title: "210 joueurs cles de la WM 2026 | Effectifs & Stats",
  description:
    "Les 210 joueurs cles des 48 équipes de la WM 2026. Statistiques, clubs, selections et buts pour chaque joueur.",
  alternates: getStaticAlternates("players", "de"),
  openGraph: {
    title: "210 joueurs clés de la WM 2026",
...
export default function PlayersPage() {
  const faqItems = [
    {
      question: "Combien de joueurs composent une équipe pour la WM ?",
      answer: "Chaque équipe peut convoquer 26 joueurs pour la WM 2026 (contre 23 auparavant). Cette règle a été adoptée par la FIFA en 2022 pour permettre plus de rotation et gérer les blessures. Parmi ces 26 joueurs, 3 doivent obligatoirement être gardiens de but. Le sélectionneur peut faire appel à tous les joueurs de la liste selon les besoins tactiques et la forme physique."
    },
    {
      question: "Qui sont les favoris pour le Ballon d'Or de la CDM 2026 ?",
      answer: "Les principaux candidats au Ballon d'Or de la WM 2026 sont Kylian Mbappé (France, déjà Ballon d'Or 2022), Erling Haaland (Norvège), Vinícius Júnior (Brésil), Jude Bellingham (Angleterre) et Lamine Yamal (Espagne). Mbappé est le grand favori grce à son statut de meilleur joueur du monde, ses 12 buts en CDM et la force de l'équipe de France. Le Ballon d'Or est attribué au meilleur joueur du tournoi, indépendamment du vainqueur final."
    },
    {
...
<section className="hero-animated text-white py-14 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <RelatedLinks variant="compact" title="Pages liées" links={[
          { href: "/torschuetzen", title: "Meilleurs buteurs", description: "Rangliste des buteurs de la CDM 2026", icon: "" },
          { href: "/comparateur-joueurs", title: "Comparateur de joueurs", description: "Comparez les stats de 2 joueurs", icon: "" },
          { href: "/mannschaft", title: "Les 48 équipes", description: "Effectifs complets par sélection", icon: "" },
          { href: "/fifa-ranking", title: "Rangliste FIFA", description: "Ranking mondial des équipes", icon: "" },
        ]} />
      </div>
