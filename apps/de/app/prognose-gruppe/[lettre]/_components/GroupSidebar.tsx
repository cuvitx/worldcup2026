  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-primary/10 border border-primary/20 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Sieger-Prognose WM 2026</h3>
        <p className="text-sm text-gray-600 mb-3">Wer hebt die Trophäe? Entdecken Sie unsere vollständige Analyse.</p>
        <Link href="/prognose/sieger" className="text-sm font-semibold text-primary hover:underline">Sieger-Prognose anzeigen →</Link>
      </div>
    </div>
  );
}
