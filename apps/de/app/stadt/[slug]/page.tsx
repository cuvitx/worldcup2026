...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${city.name} - Gastgeberstadt WM 2026 | Kompletter Guide`,
    description: `Kompletter Guide zu ${city.name} für die WM 2026. Hotels, Anreise, Stadien und Aktivitäten. ${city.description}`,
          ...
          overlayContent={
            <>
              ...
              <p className="mt-1 text-sm text-gray-200 drop-shadow">
                {city.state}, {city.country} &middot; Gastgeberstadt WM 2026
              </p>
            </>
          }
        />
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">
                {cityStadiums.length > 1 ? "Stadien" : "Stadion"} der WM
              </h2>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        ...
                        Dach {stadium.roofType === "retractable" ? "Schiebedach" : stadium.roofType === "fixed" ? "fest" : "offen"}
                      </p>
                    </div>
                  ...
                  {cityMatches.map((match) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-base shrink-0" role="img" aria-label={home?.name ?? "Unbekannt"}>{home?.flag ?? ""}</span>
                        ...
                        <span className="text-base shrink-0" role="img" aria-label={away?.name ?? "Unbekannt"}>{away?.flag ?? ""}</span>
              ...
              <>
                ...
                <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="inline-block shrink-0"><path d="M12 2v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="M20 12h2"/><path d="m19.07 4.93-1.41 1.41"/><path d="M15.947 12.65a4 4 0 0 0-5.925-4.128"/><path d="M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6Z"/></svg> Wetter im Juni-Juli
                  </h2>
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="rounded-lg bg-primary/5 p-4 text-center">
                      <p className="text-xs text-gray-500 mb-1">Juni</p>
                      <p className="text-2xl font-bold text-accent">
                        {enrichment.weather.juinMin} – {enrichment.weather.juinMax}C
                      </p>
                    </div>
                    <div className="rounded-lg bg-accent/10 p-4 text-center">
                      <p className="text-xs text-gray-500 mb-1">Juli</p>
                      <p className="text-2xl font-bold text-accent">
                ...
                <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                    <div className="rounded-lg bg-gray-50 p-3 sm:p-4 text-center">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Hotel / Nacht</p>
                    </div>
                    <div className="rounded-lg bg-gray-50 p-3 sm:p-4 text-center">
                      <p className="text-lg font-bold text-primary">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Durchschnitt. Mahlzeit</p>
                    </div>
                    <div className="rounded-lg bg-gray-50 p-3 sm:p-4 text-center">
                      <p className="text-lg font-bold text-primary">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Bier (0,5l)</p>
                    </div>
                  </div>
                </section>
                ...
                <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                     Aktivitäten abseits der Spiele
                  </h2>
                  <div className="space-y-4">
            ...
            <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Praktische Informationen</h2>
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-5 hover:shadow-md transition-shadow">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <dt className="text-gray-500">Bundesstaat / Provinz</dt>
            ...
            <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-5 hover:shadow-md transition-shadow">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Weitere Gastgeberstädte</h3>
              <ul className="space-y-2 text-sm">
                {cities
                  ...
                  .map((c) => (
                    <li key={c.id}>
                      <Link href={`/stadt/${c.slug}`} className="text-primary hover:underline">
                        {c.name} ({c.country})
                      </Link>
                    </li>
                  ))}
            ...
            <div className="rounded-xl bg-primary/5 border border-primary/20 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Hotels in {city.name}</h3>
              <p className="text-sm text-gray-600">
                Finden Sie die besten Hotels in der Nähe der Stadien für die WM 2026.
              </p>
            </div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href={`/stadt/${city.slug}`} className="text-primary hover:underline">
                    <BookOpen className="h-5 w-5 inline-block" /> Kompletter Guide zu {city.name}
                  </Link>
                </li>
                <li>
                  <Link href="/staedte" className="text-primary hover:underline">
                    <Building2 className="h-5 w-5 inline-block" /> Alle Gastgeberstädte
                  </Link>
                </li>
                <li>
