...
export const metadata: Metadata = {
  ...
  description:
    "Informations sur le jeu responsable : signes de jeu problématique, numéros d'aide (09 74 75 13 13), ressources ANJ et SOS Spielers, outils d'auto-exclusion.",
        ...
        <div className="space-y-12 text-gray-700 leading-relaxed">
          ...
          <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Spielers Info Service — appel non surtaxé, 7j/7 de 8h à 2h
            </p>
          </div>
        </div>
      </div>
